...
class FatigueFilter(OperationNode):
    ...
    def __init__(self , description="", _id=None, name=None, x=0, y=0, h=0, w=0, outputCycleCount=False, **kwargs):
        ...
        self.snCurve = None
        self.outputCycleCount = outputCycleCount
        self.cycleCountSlot = None
