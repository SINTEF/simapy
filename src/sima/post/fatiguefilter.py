...
# 
# Generated with FatigueFilter
from __future__ import annotations
from typing import Dict,Sequence,List
from dmt.entity import Entity
from dmt.blueprint import Blueprint
from .blueprints.fatiguefilter import FatigueFilterBlueprint
...
class FatigueFilter(OperationNode):
    """
    Keyword arguments
    -----------------
    name : str
    ...
    snCurve : SNCurve
    outputCycleCount : bool
         (default False)
    cycleCountSlot : OutputSlot
    """

    def __init__(self , name:str="", description:str="", _id:str="", x:int=0, y:int=0, h:int=0, w:int=0, outputCycleCount:bool=False, **kwargs):
        ...
        self.__snCurve = None
        self.__outputCycleCount = outputCycleCount
        self.__cycleCountSlot = None
    ...
    @property
    def outputCycleCount(self) -> bool:
        """"""
        return self.__outputCycleCount

    @outputCycleCount.setter
    def outputCycleCount(self, value: bool):
        """Set outputCycleCount"""
        self.__outputCycleCount = bool(value)

    @property
    def cycleCountSlot(self) -> OutputSlot:
        """"""
        return self.__cycleCountSlot

    @cycleCountSlot.setter
    def cycleCountSlot(self, value: OutputSlot):
        """Set cycleCountSlot"""
        self.__cycleCountSlot = value
