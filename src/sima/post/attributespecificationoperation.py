...
# 
# Generated with AttributeSpecificationOperation
from typing import Dict,Sequence,List
from dmt.entity import Entity
from dmt.blueprint import Blueprint
from .blueprints.attributespecificationoperation import AttributeSpecificationOperationBlueprint
from sima.post.attributespecification import AttributeSpecification
...
class AttributeSpecificationOperation(OperationNode):
    """
    Keyword arguments
    -----------------
    name : str
    ...
    renameOutput : bool
         (default True)
    specifications : List[AttributeSpecification]
    """

    def __init__(self , name:str="", description:str="", _id:str="", x:int=0, y:int=0, h:int=0, w:int=0, renameOutput:bool=True, **kwargs):
    ...
    def blueprint(self) -> Blueprint:
        ...
        return AttributeSpecificationOperationBlueprint()
    ...
    @property
    def specifications(self) -> List[AttributeSpecification]:
        """"""
        return self.__specifications

    @specifications.setter
    def specifications(self, value: List[AttributeSpecification]):
        """Set specifications"""
        if not isinstance(value, Sequence):
            raise Exception("Expected sequense, but was " , type(value))
