...
# 
# Generated with ReorderOperation
from typing import Dict,Sequence,List
from dmt.entity import Entity
from dmt.blueprint import Blueprint
from .blueprints.reorderoperation import ReorderOperationBlueprint
...
class ReorderOperation(OperationNode):
    """
    Keyword arguments
    -----------------
    name : str
    ...
    renameOutput : bool
         (default True)
    specifications : List[PathSpecification]
    """
    ...
    def blueprint(self) -> Blueprint:
        ...
        return ReorderOperationBlueprint()
    ...
    @property
    def specifications(self) -> List[PathSpecification]:
        """"""
        return self.__specifications

    @specifications.setter
    def specifications(self, value: List[PathSpecification]):
        """Set specifications"""
        if not isinstance(value, Sequence):
            raise Exception("Expected sequense, but was " , type(value))
