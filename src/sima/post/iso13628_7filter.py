...
class ISO13628_7Filter(OperationNode):
    ...
    def __init__(self , description="", _id=None, name=None, x=0, y=0, h=0, w=0, ultimateTensionCapacity=0.0, ultimateBendingCapacity=0.0, ultimatePressureCapacity=0.0, internalPressure=0.0, externalPressure=0.0, designFactor=0.8, **kwargs):
