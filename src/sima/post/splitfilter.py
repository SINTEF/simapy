...
# 
# Generated with SplitFilter
from typing import Dict,Sequence,List
from dmt.entity import Entity
from dmt.blueprint import Blueprint
from .blueprints.splitfilter import SplitFilterBlueprint
...
class SplitFilter(OperationNode):
    """
    Keyword arguments
    -----------------
    name : str
    ...
    path : str
         Add the path to the name of the signal tree B to remove from input A(default "")
    """
    ...
    @property
    def path(self) -> str:
        """Add the path to the name of the signal tree B to remove from input A"""
        return self.__path
