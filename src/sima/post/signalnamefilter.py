...
# 
# Generated with SignalNameFilter
from typing import Dict,Sequence,List
from dmt.entity import Entity
from dmt.blueprint import Blueprint
from .blueprints.signalnamefilter import SignalNameFilterBlueprint
from sima.post.controlsignalinputslot import ControlSignalInputSlot
from sima.post.inputslot import InputSlot
from sima.post.namespecification import NameSpecification
from sima.post.operationnode import OperationNode
from sima.post.outputslot import OutputSlot
from sima.sima.scriptablevalue import ScriptableValue

class SignalNameFilter(OperationNode):
    """
    Keyword arguments
    -----------------
    name : str
    ...
    nameSpecifications : List[NameSpecification]
    """
    ...
    def __init__(self , name:str="", description:str="", _id:str="", x:int=0, y:int=0, h:int=0, w:int=0, **kwargs):
        ...
        self.__nameSpecifications = list()
    ...
    def blueprint(self) -> Blueprint:
        ...
        return SignalNameFilterBlueprint()
    ...
    @property
    def nameSpecifications(self) -> List[NameSpecification]:
        """"""
        return self.__nameSpecifications

    @nameSpecifications.setter
    def nameSpecifications(self, value: List[NameSpecification]):
        """Set nameSpecifications"""
        if not isinstance(value, Sequence):
            raise Exception("Expected sequense, but was " , type(value))
        self.__nameSpecifications = value
