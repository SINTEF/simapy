...
# 
# Generated with CollisionFilter
from typing import Dict,Sequence,List
from dmt.entity import Entity
from dmt.blueprint import Blueprint
from .blueprints.collisionfilter import CollisionFilterBlueprint
...
class CollisionFilter(OperationNode):
    """
    Keyword arguments
    -----------------
    name : str
    ...
    velocity : float
         Drift velocity of vessel(default 0.0)
    """

    def __init__(self , name:str="", description:str="", _id:str="", x:int=0, y:int=0, h:int=0, w:int=0, velocity:float=0.0, **kwargs):
    ...
    def blueprint(self) -> Blueprint:
        ...
        return CollisionFilterBlueprint()
