...
# 
# Generated with SortOperationFilter
...
class SortOperationFilter(OperationNode):
    ...
    retainX : bool
         Retain x-axis when sorting by y(default True)
    """

    def __init__(self , name:str="", description:str="", _id:str="", x:int=0, y:int=0, h:int=0, w:int=0, renameOutput:bool=True, sortBy:SortBy=SortBy.X_AXIS, sortDirection:SortDirection=SortDirection.ASCENDING, retainX:bool=True, **kwargs):
    ...
    def blueprint(self) -> Blueprint:
        ...
        return SortOperationFilterBlueprint()
    ...
    @property
    def retainX(self) -> bool:
        """Retain x-axis when sorting by y"""
        return self.__retainX

    @retainX.setter
    def retainX(self, value: bool):
        """Set retainX"""
        self.__retainX = bool(value)
