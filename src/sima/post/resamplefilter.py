...
class ResampleFilter(OperationNode):
    ...
    def __init__(self , description="", _id=None, name=None, x=0, y=0, h=0, w=0, renameOutput=True, newSamplingInterval=0.0, offset=0.0, useMinimalDelta=False, **kwargs):
        ...
        self.newSamplingInterval = newSamplingInterval
        self.offset = offset
        self.useMinimalDelta = useMinimalDelta
