...
class ResampleFilter(OperationNode):
    """
    Keyword arguments
    -----------------
    name : str
    ...
    def __init__(self , name:str="", description:str="", _id:str="", x:int=0, y:int=0, h:int=0, w:int=0, renameOutput:bool=True, newSamplingInterval:float=0.0, offset:float=0.0, useMinimalDelta:bool=False, **kwargs):
        ...
        self.__newSamplingInterval = newSamplingInterval
        self.__offset = offset
        self.__useMinimalDelta = useMinimalDelta
    ...
    def blueprint(self) -> Blueprint:
        ...
        return ResampleFilterBlueprint()
    ...
    @property
    def newSamplingInterval(self) -> float:
        """New sampling interval"""
        return self.__newSamplingInterval

    @newSamplingInterval.setter
    def newSamplingInterval(self, value: float):
        """Set newSamplingInterval"""
        self.__newSamplingInterval = float(value)
    ...
    @property
    def useMinimalDelta(self) -> bool:
        """Will pick the smallest delta and resample according to this."""
        return self.__useMinimalDelta

    @useMinimalDelta.setter
    def useMinimalDelta(self, value: bool):
        """Set useMinimalDelta"""
        self.__useMinimalDelta = bool(value)
