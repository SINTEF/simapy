...
# 
# Generated with JoinFilter
from typing import Dict,Sequence,List
from dmt.entity import Entity
from dmt.blueprint import Blueprint
from .blueprints.joinfilter import JoinFilterBlueprint
...
class JoinFilter(OperationNode):
    """
    Keyword arguments
    -----------------
    name : str
    ...
    path : str
         Add the path to the name of the signal tree A and add signal tree B to this(default "")
    """

    def __init__(self , name:str="", description:str="", _id:str="", x:int=0, y:int=0, h:int=0, w:int=0, path:str="", **kwargs):
    ...
    @property
    def path(self) -> str:
        """Add the path to the name of the signal tree A and add signal tree B to this"""
        return self.__path
