...
# 
# Generated with SimplifiedFatigueFilter
from typing import Dict,Sequence,List
from dmt.entity import Entity
from dmt.blueprint import Blueprint
from .blueprints.simplifiedfatiguefilter import SimplifiedFatigueFilterBlueprint
...
class SimplifiedFatigueFilter(OperationNode):
    """
    Keyword arguments
    -----------------
    name : str
    ...
    def __init__(self , name:str="", description:str="", _id:str="", x:int=0, y:int=0, h:int=0, w:int=0, renameOutput:bool=True, numberOfCycles:int=0, shape:float=0.0, intercept:float=0.0, slope:float=0.0, **kwargs):
    ...
    def blueprint(self) -> Blueprint:
        ...
        return SimplifiedFatigueFilterBlueprint()
