...
# 
# Generated with ExtractSignalAttributeOperation
from typing import Dict,Sequence,List
from dmt.entity import Entity
from dmt.blueprint import Blueprint
from .blueprints.extractsignalattributeoperation import ExtractSignalAttributeOperationBlueprint
...
class ExtractSignalAttributeOperation(OperationNode):
    """
    Keyword arguments
    -----------------
    name : str
    ...
    def __init__(self , name:str="", description:str="", _id:str="", x:int=0, y:int=0, h:int=0, w:int=0, renameOutput:bool=True, attribute:str='name', includeContainers:bool=False, convert:bool=False, **kwargs):
        ...
        self.__includeContainers = includeContainers
    ...
    def includeContainers(self) -> bool:
        """"""
        return self.__includeContainers

    @includeContainers.setter
    def includeContainers(self, value: bool):
        """Set includeContainers"""
        self.__includeContainers = bool(value)

    @property
    def convert(self) -> bool:
        """Convert string attributes to number if detected"""
        return self.__convert

    @convert.setter
    def convert(self, value: bool):
        """Set convert"""
        self.__convert = bool(value)
