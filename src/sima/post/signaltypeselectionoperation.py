...
# 
# Generated with SignalTypeSelectionOperation
from typing import Dict,Sequence,List
from dmt.entity import Entity
from dmt.blueprint import Blueprint
from .blueprints.signaltypeselectionoperation import SignalTypeSelectionOperationBlueprint
from sima.post.controlsignalinputslot import ControlSignalInputSlot
from sima.post.inputslot import InputSlot
from sima.post.operationnode import OperationNode
from sima.post.outputslot import OutputSlot
from sima.post.signaltype import SignalType
from sima.sima.scriptablevalue import ScriptableValue

class SignalTypeSelectionOperation(OperationNode):
    """
    Keyword arguments
    -----------------
    name : str
    ...
    def __init__(self , name:str="", description:str="", _id:str="", x:int=0, y:int=0, h:int=0, w:int=0, renameOutput:bool=True, types:SignalType=SignalType.CONSTANT, **kwargs):
    ...
    def blueprint(self) -> Blueprint:
        ...
        return SignalTypeSelectionOperationBlueprint()
    ...
    @property
    def types(self) -> SignalType:
        """"""
        return self.__types

    @types.setter
    def types(self, value: SignalType):
        """Set types"""
        self.__types = value
