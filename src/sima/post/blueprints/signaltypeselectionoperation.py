# 
# Generated with SignalTypeSelectionOperationBlueprint
...
class SignalTypeSelectionOperationBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="SignalTypeSelectionOperation", package_path="sima/post", description=""):
        ...
        self.attributes.append(EnumAttribute("types","sima/post/SignalType",""))