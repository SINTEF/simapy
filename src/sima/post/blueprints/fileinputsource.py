# 
# Generated with FileInputSourceBlueprint
...
class FileInputSourceBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="FileInputSource", package_path="sima/post", description=""):
        ...
        self.attributes.append(Attribute("fileFromInput","boolean","Input the filename to be imported from an input slot",default=False))
        self.attributes.append(EnumAttribute("format","sima/post/FileInputFormat",""))
        self.attributes.append(Attribute("firstIsX","boolean","Use the first signal as the x axis for all inputs",default=False))