# 
# Generated with AmplitudeFilterBlueprint
...
class AmplitudeFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="AmplitudeFilter", package_path="sima/post", description=""):
        ...
        self.attributes.append(EnumAttribute("_type","sima/post/AmplitudeType",""))
        self.attributes.append(EnumAttribute("amplitude","sima/post/Amplitude",""))