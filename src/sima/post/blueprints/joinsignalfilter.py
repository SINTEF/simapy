# 
# Generated with JoinSignalFilterBlueprint
...
class JoinSignalFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="JoinSignalFilter", package_path="sima/post", description=""):
