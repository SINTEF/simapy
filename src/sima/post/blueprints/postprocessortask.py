...
class PostProcessorTaskBlueprint(TaskBlueprint):
    ...
    def __init__(self, name="PostProcessorTask", package_path="sima/post", description=""):
        ...
        self.attributes.append(BlueprintAttribute("postProcessors","sima/post/PostProcessorSpecification","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("snCurves","sima/post/SNCurve","",True,Dimension("size","")))