# 
# Generated with CollisionFilterBlueprint
...
class CollisionFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="CollisionFilter", package_path="sima/post", description=""):
        ...
        self.attributes.append(Attribute("velocity","number","Drift velocity of vessel",default=0.0))