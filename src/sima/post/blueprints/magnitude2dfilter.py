# 
# Generated with Magnitude2DFilterBlueprint
...
class Magnitude2DFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="Magnitude2DFilter", package_path="sima/post", description=""):
