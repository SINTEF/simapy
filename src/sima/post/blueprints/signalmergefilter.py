# 
# Generated with SignalMergeFilterBlueprint
...
class SignalMergeFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="SignalMergeFilter", package_path="sima/post", description=""):
