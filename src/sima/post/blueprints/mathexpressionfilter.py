# 
# Generated with MathExpressionFilterBlueprint
...
class MathExpressionFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="MathExpressionFilter", package_path="sima/post", description=""):
