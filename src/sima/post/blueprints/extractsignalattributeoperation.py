...
class ExtractSignalAttributeOperationBlueprint(OperationNodeBlueprint):
    ...
    def __init__(self, name="ExtractSignalAttributeOperation", package_path="sima/post", description=""):
        ...
        self.add_attribute(Attribute("attribute","string","",default='name'))
        self.add_attribute(Attribute("includeContainers","boolean","",default=False))
        self.add_attribute(Attribute("convert","boolean","Convert string attributes to number if detected",default=False))