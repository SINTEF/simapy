...
class PipeStressFilterBlueprint(OperationNodeBlueprint):
    ...
    def __init__(self, name="PipeStressFilter", package_path="sima/post", description=""):
        ...
        self.attributes.append(Attribute("pipeThickness","number","",default=0.0))
        ...
        self.attributes.append(EnumAttribute("positionForStressCalculation","sima/post/WallPoint",""))