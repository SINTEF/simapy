# 
# Generated with NormalisationFilterBlueprint
...
class NormalisationFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="NormalisationFilter", package_path="sima/post", description=""):
