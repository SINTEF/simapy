# 
# Generated with LinearInterpolationFilterBlueprint
...
class LinearInterpolationFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="LinearInterpolationFilter", package_path="sima/post", description=""):
