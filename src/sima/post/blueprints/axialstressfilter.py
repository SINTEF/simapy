# 
# Generated with AxialStressFilterBlueprint
...
class AxialStressFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="AxialStressFilter", package_path="sima/post", description=""):
        ...
        self.attributes.append(Attribute("area","number","",default=0.0))