# 
# Generated with AddFilterBlueprint
...
class AddFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="AddFilter", package_path="sima/post", description=""):
        ...
        self.attributes.append(Attribute("addAll","boolean","Add all inputs together element wise. The inputs will need to have same size",default=False))