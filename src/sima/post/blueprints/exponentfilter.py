# 
# Generated with ExponentFilterBlueprint
...
class ExponentFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="ExponentFilter", package_path="sima/post", description=""):
        ...
        self.attributes.append(Attribute("exp","number","Exponent value",default=0.0))