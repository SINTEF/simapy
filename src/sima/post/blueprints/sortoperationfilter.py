# 
# Generated with SortOperationFilterBlueprint
...
class SortOperationFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="SortOperationFilter", package_path="sima/post", description=""):
        ...
        self.attributes.append(EnumAttribute("sortBy","sima/post/SortBy",""))
        self.attributes.append(EnumAttribute("sortDirection","sima/post/SortDirection",""))
        self.attributes.append(Attribute("retainX","boolean","Retain x-axis when sorting by y",default=True))