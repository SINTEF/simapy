# 
# Generated with NoteFilterBlueprint
...
class NoteFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="NoteFilter", package_path="sima/post", description=""):
