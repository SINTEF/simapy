...
class IndexSelectionFilterBlueprint(OperationNodeBlueprint):
    ...
    def __init__(self, name="IndexSelectionFilter", package_path="sima/post", description=""):
        ...
        self.attributes.append(Attribute("lastIndex","boolean","Select the last index",default=False))
        self.attributes.append(Attribute("index","integer","Select the given zero-based index of the input signal",default=0))