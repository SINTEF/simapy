# 
# Generated with IndexSelectionFilterBlueprint
...
class IndexSelectionFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="IndexSelectionFilter", package_path="sima/post", description=""):
        ...
        self.add_attribute(EnumAttribute("axis","sima/post/SignalAxis","Select the value from the x-axis or the y-axis"))
        self.add_attribute(Attribute("lastIndex","boolean","Select the last index",default=False))
        self.add_attribute(Attribute("index","integer","Select the given zero-based index of the input signal",default=0))