...
class BandPassFilterBlueprint(OperationNodeBlueprint):
    ...
    def __init__(self, name="BandPassFilter", package_path="sima/post", description=""):
        ...
        self.attributes.append(Attribute("lowerCutoffFrequency","number","Lower cut off frequency",default=0.0))
        self.attributes.append(Attribute("upperCutoffFrequency","number","Upper cut off frequency",default=0.0))