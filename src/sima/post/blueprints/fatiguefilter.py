# 
# Generated with FatigueFilterBlueprint
...
class FatigueFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="FatigueFilter", package_path="sima/post", description=""):
        ...
        self.attributes.append(BlueprintAttribute("snCurve","sima/post/SNCurve","",False))
        self.attributes.append(Attribute("outputCycleCount","boolean","",default=False))
        self.attributes.append(BlueprintAttribute("cycleCountSlot","sima/post/OutputSlot","",True))