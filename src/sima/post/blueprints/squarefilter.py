# 
# Generated with SquareFilterBlueprint
...
class SquareFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="SquareFilter", package_path="sima/post", description=""):
