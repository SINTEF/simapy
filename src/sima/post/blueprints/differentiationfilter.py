# 
# Generated with DifferentiationFilterBlueprint
...
class DifferentiationFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="DifferentiationFilter", package_path="sima/post", description=""):
