...
class ScaleFilterBlueprint(OperationNodeBlueprint):
    ...
    def __init__(self, name="ScaleFilter", package_path="sima/post", description=""):
        ...
        self.attributes.append(Attribute("scale","number","scale input series with given factor",default=1.0))
        self.attributes.append(Attribute("unit","string","unit of scale parameter",default='-'))
