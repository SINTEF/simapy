# 
# Generated with ScaleFilterBlueprint
...
class ScaleFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="ScaleFilter", package_path="sima/post", description=""):
        ...
        self.add_attribute(Attribute("scale","number","scale input series with given factor",default=1.0))
        self.add_attribute(Attribute("unit","string","unit of scale parameter",default='-'))
