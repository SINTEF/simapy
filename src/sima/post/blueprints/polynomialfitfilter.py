# 
# Generated with PolynomialFitFilterBlueprint
...
class PolynomialFitFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="PolynomialFitFilter", package_path="sima/post", description=""):
        ...
        self.attributes.append(Attribute("polynomalPower","integer","Polynomal power.",default=2))
        self.attributes.append(Attribute("subtract","boolean","Subtract result from original signal",default=False))