# 
# Generated with TransformationFilterBlueprint
...
class TransformationFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="TransformationFilter", package_path="sima/post", description=""):
        ...
        self.attributes.append(Attribute("xp","number","",default=0.0))
        self.attributes.append(Attribute("yp","number","",default=0.0))
        self.attributes.append(Attribute("zp","number","",default=0.0))