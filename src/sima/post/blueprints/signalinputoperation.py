# 
# Generated with SignalInputOperationBlueprint
...
class SignalInputOperationBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="SignalInputOperation", package_path="sima/post", description=""):
        ...
        self.attributes.append(BlueprintAttribute("inputs","sima/post/InputSlot","",True,Dimension("size","")))
