...
class WindowFilterBlueprint(OperationNodeBlueprint):
    ...
    def __init__(self, name="WindowFilter", package_path="sima/post", description=""):
        ...
        self.add_attribute(Attribute("useIndex","boolean","Specify start and end index of signal",default=False))
        self.add_attribute(Attribute("start","number","",default=0.0))
        self.add_attribute(Attribute("end","number","",default=0.0))
        self.add_attribute(Attribute("setStartValue","boolean","",default=False))
        self.add_attribute(Attribute("startValue","number","",default=0.0))
        self.add_attribute(Attribute("startIndex","integer","",default=0))
        self.add_attribute(Attribute("endIndex","integer","End index or last index if not set",default=0))