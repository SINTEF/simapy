# 
# Generated with ConstraintFilterBlueprint
...
class ConstraintFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="ConstraintFilter", package_path="sima/post", description=""):
        ...
        self.attributes.append(BlueprintAttribute("constraints","sima/post/ConstraintItem","",True,Dimension("size","")))