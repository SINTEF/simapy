# 
# Generated with HighPassFilterBlueprint
...
class HighPassFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="HighPassFilter", package_path="sima/post", description=""):
        ...
        self.add_attribute(Attribute("cutoffFrequency","number","Cut off frequency",default=0.0))