# 
# Generated with SignalNameFilterBlueprint
...
class SignalNameFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="SignalNameFilter", package_path="sima/post", description=""):
        ...
        self.attributes.append(BlueprintAttribute("nameSpecifications","sima/post/NameSpecification","",True,Dimension("size","")))