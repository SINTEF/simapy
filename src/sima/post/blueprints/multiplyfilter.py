# 
# Generated with MultiplyFilterBlueprint
...
class MultiplyFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="MultiplyFilter", package_path="sima/post", description=""):
