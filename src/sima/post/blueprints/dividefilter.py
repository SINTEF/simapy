# 
# Generated with DivideFilterBlueprint
...
class DivideFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="DivideFilter", package_path="sima/post", description=""):
