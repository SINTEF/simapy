...
class ColumnConfigurationBlueprint(PathSpecificationBlueprint):
    ...
    def __init__(self, name="ColumnConfiguration", package_path="sima/post", description=""):
        ...
        self.add_attribute(Attribute("header","string","Column header. The default value is the header,legend or name attribute of the signal",default=None))
        self.add_attribute(Attribute("label","string","Column label. The default value is the unit of the y axis, or the label attribute, or ylabel + unit if specified",default=None))
