# 
# Generated with AttributeSpecificationOperationBlueprint
...
class AttributeSpecificationOperationBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="AttributeSpecificationOperation", package_path="sima/post", description=""):
        ...
        self.attributes.append(BlueprintAttribute("specifications","sima/post/AttributeSpecification","",True,Dimension("size","")))