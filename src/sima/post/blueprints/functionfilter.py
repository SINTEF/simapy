...
class FunctionFilterBlueprint(OperationNodeBlueprint):
    ...
    def __init__(self, name="FunctionFilter", package_path="sima/post", description=""):
        ...
        self.attributes.append(Attribute("function","string","",default=""))
        self.attributes.append(BlueprintAttribute("variables","sima/post/FunctionVariable","",True,Dimension("size","")))