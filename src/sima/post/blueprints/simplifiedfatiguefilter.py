# 
# Generated with SimplifiedFatigueFilterBlueprint
...
class SimplifiedFatigueFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="SimplifiedFatigueFilter", package_path="sima/post", description=""):
