# 
# Generated with HttpInputSourceBlueprint
...
class HttpInputSourceBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="HttpInputSource", package_path="sima/post", description=""):
        ...
        self.add_attribute(Attribute("url","string","",default=None))
