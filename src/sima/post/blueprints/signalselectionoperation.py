# 
# Generated with SignalSelectionOperationBlueprint
...
class SignalSelectionOperationBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="SignalSelectionOperation", package_path="sima/post", description=""):
        ...
        self.attributes.append(BlueprintAttribute("requirementOutputSlots","sima/post/RequirementOutputSlot","",True,Dimension("size","")))