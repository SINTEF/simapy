...
# 
# Generated with FlattenFilter
from typing import Dict,Sequence,List
from dmt.entity import Entity
from dmt.blueprint import Blueprint
from .blueprints.flattenfilter import FlattenFilterBlueprint
...
class FlattenFilter(OperationNode):
    """
    Keyword arguments
    -----------------
    name : str
    ...
    def __init__(self , name:str="", description:str="", _id:str="", x:int=0, y:int=0, h:int=0, w:int=0, renameOutput:bool=True, addPath:bool=True, **kwargs):
    ...
    def addPath(self) -> bool:
        """Add the path to the name of the signal to ensure uniqueness"""
        return self.__addPath

    @addPath.setter
    def addPath(self, value: bool):
        """Set addPath"""
        self.__addPath = bool(value)
