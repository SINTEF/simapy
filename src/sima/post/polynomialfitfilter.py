...
class PolynomialFitFilter(OperationNode):
    ...
    def __init__(self , name:str="", description:str="", _id:str="", x:int=0, y:int=0, h:int=0, w:int=0, renameOutput:bool=True, polynomalPower:int=2, subtract:bool=False, **kwargs):
        ...
        self.__polynomalPower = polynomalPower
