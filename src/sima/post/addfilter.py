...
# 
# Generated with AddFilter
from typing import Dict,Sequence,List
from dmt.entity import Entity
from dmt.blueprint import Blueprint
from .blueprints.addfilter import AddFilterBlueprint
...
class AddFilter(OperationNode):
    ...
    renameOutput : bool
         (default True)
    addAll : bool
         Add all inputs together element wise. The inputs will need to have same size(default False)
    """

    def __init__(self , name:str="", description:str="", _id:str="", x:int=0, y:int=0, h:int=0, w:int=0, renameOutput:bool=True, addAll:bool=False, **kwargs):
    ...
    def addAll(self) -> bool:
        """Add all inputs together element wise. The inputs will need to have same size"""
        return self.__addAll

    @addAll.setter
    def addAll(self, value: bool):
        """Set addAll"""
        self.__addAll = bool(value)
