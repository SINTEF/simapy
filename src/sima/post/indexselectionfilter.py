...
# 
# Generated with IndexSelectionFilter
from typing import Dict,Sequence,List
from dmt.entity import Entity
from dmt.blueprint import Blueprint
from .blueprints.indexselectionfilter import IndexSelectionFilterBlueprint
...
class IndexSelectionFilter(OperationNode):
    """
    Keyword arguments
    -----------------
    name : str
    ...
    lastIndex : bool
         Select the last index(default False)
    index : int
         Select the given zero-based index of the input signal(default 0)
    """

    def __init__(self , name:str="", description:str="", _id:str="", x:int=0, y:int=0, h:int=0, w:int=0, renameOutput:bool=True, axis:SignalAxis=SignalAxis.Y, lastIndex:bool=False, index:int=0, **kwargs):
    ...
    def blueprint(self) -> Blueprint:
        ...
        return IndexSelectionFilterBlueprint()
    ...
    @property
    def lastIndex(self) -> bool:
        """Select the last index"""
        return self.__lastIndex

    @lastIndex.setter
    def lastIndex(self, value: bool):
        """Set lastIndex"""
        self.__lastIndex = bool(value)

    @property
    def index(self) -> int:
        """Select the given zero-based index of the input signal"""
        return self.__index
