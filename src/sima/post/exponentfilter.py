...
# 
# Generated with ExponentFilter
from typing import Dict,Sequence,List
from dmt.entity import Entity
from dmt.blueprint import Blueprint
from .blueprints.exponentfilter import ExponentFilterBlueprint
...
class ExponentFilter(OperationNode):
    """
    Keyword arguments
    -----------------
    name : str
    ...
    renameOutput : bool
         (default True)
    exp : float
         Exponent value(default 0.0)
    """

    def __init__(self , name:str="", description:str="", _id:str="", x:int=0, y:int=0, h:int=0, w:int=0, renameOutput:bool=True, exp:float=0.0, **kwargs):
    ...
    def blueprint(self) -> Blueprint:
        ...
        return ExponentFilterBlueprint()
