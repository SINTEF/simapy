...
# 
# Generated with TwoParameterMathExpressionFilter
from typing import Dict,Sequence,List
from dmt.entity import Entity
from dmt.blueprint import Blueprint
from .blueprints.twoparametermathexpressionfilter import TwoParameterMathExpressionFilterBlueprint
...
class TwoParameterMathExpressionFilter(OperationNode):
    """
    Keyword arguments
    -----------------
    name : str
    ...
    def __init__(self , name:str="", description:str="", _id:str="", x:int=0, y:int=0, h:int=0, w:int=0, renameOutput:bool=True, function:str="", **kwargs):
    ...
    def blueprint(self) -> Blueprint:
        ...
        return TwoParameterMathExpressionFilterBlueprint()
