...
# 
# Generated with LinearInterpolationFilter
from typing import Dict,Sequence,List
from dmt.entity import Entity
from dmt.blueprint import Blueprint
from .blueprints.linearinterpolationfilter import LinearInterpolationFilterBlueprint
...
class LinearInterpolationFilter(OperationNode):
    """
    Keyword arguments
    -----------------
    name : str
    ...
    def __init__(self , name:str="", description:str="", _id:str="", x:int=0, y:int=0, h:int=0, w:int=0, renameOutput:bool=True, axis:SignalAxis=SignalAxis.Y, **kwargs):
    ...
    def blueprint(self) -> Blueprint:
        ...
        return LinearInterpolationFilterBlueprint()
