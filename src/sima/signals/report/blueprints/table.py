...
class TableBlueprint(ReportItemBlueprint):
    ...
    def __init__(self, name="Table", package_path="sima/signals/report", description=""):
        ...
        self.add_attribute(BlueprintAttribute("columns","sima/signals/report/Column","",True,Dimension("*")))