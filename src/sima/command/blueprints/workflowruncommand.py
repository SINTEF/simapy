# 
# Generated with WorkflowRunCommandBlueprint
...
class WorkflowRunCommandBlueprint(CommandBlueprint):
    ...
    def __init__(self, name="WorkflowRunCommand", package_path="sima/command", description=""):
        ...
        self.add_attribute(Attribute("file","string","Optional path to SIMA stask to import before running the workflow"))
