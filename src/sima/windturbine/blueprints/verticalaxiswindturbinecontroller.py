...
class VerticalAxisWindTurbineControllerBlueprint(MOAOBlueprint):
    ...
    def __init__(self, name="VerticalAxisWindTurbineController", package_path="sima/windturbine", description=""):
        ...
        self.attributes.append(BlueprintAttribute("windRotorSpeedItems","sima/windturbine/WindRotorSpeedItem","",True,Dimension("*")))
        self.attributes.append(BlueprintAttribute("gainSchedulingItems","sima/windturbine/GainSchedulingItem","",True,Dimension("*")))