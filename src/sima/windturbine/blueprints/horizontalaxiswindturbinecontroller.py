...
class HorizontalAxisWindTurbineControllerBlueprint(MOAOBlueprint):
    ...
    def __init__(self, name="HorizontalAxisWindTurbineController", package_path="sima/windturbine", description=""):
        ...
        self.add_attribute(Attribute("controllerFile","string","Path to controller file",default=None))
        self.add_attribute(Attribute("className","string","Class name of controller",default=None))
        self.add_attribute(Attribute("configuration","string","Configuration filename",default=None))
