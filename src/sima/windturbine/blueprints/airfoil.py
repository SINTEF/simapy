...
class AirfoilBlueprint(NamedObjectBlueprint):
    ...
    def __init__(self, name="Airfoil", package_path="sima/windturbine", description=""):
        ...
        self.attributes.append(BlueprintAttribute("reynoldItems","sima/windturbine/ReynoldItem","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("points","sima/windturbine/FoilPoint","",True,Dimension("size","")))