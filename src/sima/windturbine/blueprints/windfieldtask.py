...
class WindFieldTaskBlueprint(ConditionTaskBlueprint):
    ...
    def __init__(self, name="WindFieldTask", package_path="sima/windturbine", description=""):
        ...
        self.attributes.append(BlueprintAttribute("mannWindGenerator","sima/windturbine/MannWindGenerator","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("turbSimWindGenerator","sima/windturbine/TurbSimWindGenerator","",True,Dimension("size","")))