...
class FluctuatingThreeComponentBlueprint(WindBlueprint):
    ...
    def __init__(self, name="FluctuatingThreeComponent", package_path="sima/environment", description=""):
        ...
        self.add_attribute(Attribute("longitudinalFileName","string","Path and filename for the fluctuating longitudinal wind time series",default=None))
        self.add_attribute(Attribute("lateralFileName","string","Path and filename for the fluctuating lateral wind time series",default=None))
        self.add_attribute(Attribute("verticalFileName","string","Path and filename for the fluctuating vertical wind time series",default=None))
