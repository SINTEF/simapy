...
class NPDWind(Wind):
    ...
    def __init__(self , name:str="", description:str="", _id:str="", direction:float=0.0, profileExponent:float=0.11, averageVelocity:float=0.0, friction:float=0.002, referenceHeight:float=10.0, **kwargs):
