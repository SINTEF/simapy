...
class BretschneiderTwo(Wave):
    ...
    def __init__(self , _id="", direction=0.0, spreadingExponent=2.0, numDirections=11, spreadingType=WaveSpreadingType.UNIDIRECTIONAL, waveHeight=0.0, period=0.0, **kwargs):
