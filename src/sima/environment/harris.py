...
class Harris(DavenPort):
    ...
    def __init__(self , description="", _id=None, direction=0.0, profileExponent=0.11, averageVelocity=0.0, friction=0.002, referenceHeight=10.0, referenceLength=1200.0, **kwargs):
