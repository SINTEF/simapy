...
class FluctuatingWindVelocityProfile(WindVelocityProfile):
    ...
    def __init__(self , name:str="", description:str="", _id:str="", verticalCoordinate:float=0.0, longitudinalVelocityFactor:float=0.0, lateralVelocityFactor:float=0.0, verticalVelocityFactor:float=0.0, meanSpeedFactor:float=0.0, **kwargs):
        ...
        self.__meanSpeedFactor = meanSpeedFactor
