...
class BretschneiderOne(Wave):
    ...
    def __init__(self , description="", _id=None, direction=0.0, spreadingExponent=2.0, numDirections=11, spreadingType=WaveSpreadingType.UNIDIRECTIONAL, fetch=0.0, windSpeed=0.0, **kwargs):
