...
# 
# Generated with PiersonMoskowitzISSC
...
class PiersonMoskowitzISSC(PiersonMoskowitz):
    ...
    def __init__(self , name:str="", description:str="", _id:str="", direction:float=0.0, spreadingExponent:float=2.0, numDirections:int=11, spreadingType:WaveSpreadingType=WaveSpreadingType.UNIDIRECTIONAL, significantWaveHeight:float=0.0, averagePeriod:float=0.0, **kwargs):
        ...
        self.__averagePeriod = averagePeriod
    ...
    def blueprint(self) -> Blueprint:
        ...
        return PiersonMoskowitzISSCBlueprint()
    ...
    def averagePeriod(self) -> float:
        """Average wave period"""
        return self.__averagePeriod

    @averagePeriod.setter
    def averagePeriod(self, value: float):
        """Set averagePeriod"""
        self.__averagePeriod = float(value)
