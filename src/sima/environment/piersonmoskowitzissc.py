...
class PiersonMoskowitzISSC(PiersonMoskowitz):
    ...
    def __init__(self , description="", direction=0.0, spreadingExponent=2.0, numDirections=11, spreadingType=WaveSpreadingType.UNIDIRECTIONAL, significantWaveHeight=0.0, averagePeriod=0.0, **kwargs):
