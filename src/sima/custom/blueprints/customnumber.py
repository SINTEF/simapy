# 
# Generated with CustomNumberBlueprint
...
class CustomNumberBlueprint(ParameterFieldBlueprint,NamedBlueprint):
    """"""

    def __init__(self, name="CustomNumber", package_path="sima/custom", description=""):
