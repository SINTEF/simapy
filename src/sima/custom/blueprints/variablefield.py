...
class VariableFieldBlueprint(ParameterFieldBlueprint):
    ...
    def __init__(self, name="VariableField", package_path="sima/custom", description=""):
        ...
        self.add_attribute(Attribute("fileExtensions","string","Describes legal file extensions separated by semicolon, example:  *.txt;*.dat",default=None))
        self.add_attribute(Attribute("options","string","",Dimension("*"),default=None))
