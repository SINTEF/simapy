...
class CustomEditorTaskBlueprint(TaskBlueprint):
    ...
    def __init__(self, name="CustomEditorTask", package_path="sima/custom", description=""):
        ...
        self.attributes.append(BlueprintAttribute("editors","sima/custom/CustomEditor","",True,Dimension("*")))
        self.attributes.append(BlueprintAttribute("wizards","sima/custom/CustomWizard","",True,Dimension("*")))