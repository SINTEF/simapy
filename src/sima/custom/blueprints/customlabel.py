# 
# Generated with CustomLabelBlueprint
...
class CustomLabelBlueprint(CustomComponentBlueprint):
    """"""

    def __init__(self, name="CustomLabel", package_path="sima/custom", description=""):
