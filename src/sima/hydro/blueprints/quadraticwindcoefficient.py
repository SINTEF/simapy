...
class QuadraticWindCoefficientBlueprint(MOAOBlueprint):
    ...
    def __init__(self, name="QuadraticWindCoefficient", package_path="sima/hydro", description=""):
        ...
        self.add_attribute(Attribute("fileName","string","Text file containing the wind coefficients. The force coefficents in the file must be specified in [kN/(m/s)] for translational degrees of freedom and [kN.s] for rotational degrees of freedom.",default=None))