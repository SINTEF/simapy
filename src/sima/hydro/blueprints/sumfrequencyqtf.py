...
class SumFrequencyQTFBlueprint(SparseQTFBlueprint):
    ...
    def __init__(self, name="SumFrequencyQTF", package_path="sima/hydro", description=""):
        ...
        self.attributes.append(Attribute("di","integer","",Dimension("size",""),default=0))
        self.attributes.append(Attribute("dj","integer","",Dimension("size",""),default=0))
        self.attributes.append(Attribute("wi","integer","",Dimension("size",""),default=0))
        self.attributes.append(Attribute("wj","integer","",Dimension("size",""),default=0))
