# 
# Generated with SumFrequencyWaveForceBlueprint
...
class SumFrequencyWaveForceBlueprint(QuadraticTransferFunctionBlueprint):
    """"""

    def __init__(self, name="SumFrequencyWaveForce", package_path="sima/hydro", description=""):
        ...
        self.add_attribute(Attribute("file","string","",default=None))
