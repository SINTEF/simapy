...
class GeneratorBlueprint(NamedBlueprint,ConditionSelectableBlueprint):
    ...
    def __init__(self, name="Generator", package_path="sima/windpark", description=""):
        ...
        self.add_attribute(Attribute("deficitFileName","string","",default=None))
        ...
        self.add_attribute(Attribute("coarseMeshFilename","string","",default=None))
        self.add_attribute(Attribute("fineMeshFilename","string","",default=None))
        self.add_attribute(Attribute("ambientWindFieldFilename","string","",default=None))
