# 
# Generated with PassThroughNodeBlueprint
...
class PassThroughNodeBlueprint(RunNodeBlueprint):
    """"""

    def __init__(self, name="PassThroughNode", package_path="sima/workflow", description=""):
