# 
# Generated with FileResolveNodeBlueprint
...
class FileResolveNodeBlueprint(RunNodeBlueprint):
    """"""

    def __init__(self, name="FileResolveNode", package_path="sima/workflow", description=""):
