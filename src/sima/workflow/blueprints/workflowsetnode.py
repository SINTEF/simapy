...
class WorkflowSetNodeBlueprint(WorkflowReferenceNodeBlueprint):
    ...
    def __init__(self, name="WorkflowSetNode", package_path="sima/workflow", description=""):
        ...
        self.attributes.append(BlueprintAttribute("workflowOutputSlots","sima/workflow/WorkflowOutputSlot","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("workflowInputSlots","sima/workflow/WorkflowInputSlot","",True,Dimension("size","")))
        ...
        self.attributes.append(BlueprintAttribute("variableInputSets","sima/workflow/VariableInputSet","",True,Dimension("size","")))
        ...
        self.attributes.append(BlueprintAttribute("variableInputSetSlots","sima/workflow/VariableInputSetSlot","",True,Dimension("size","")))
        ...
        self.attributes.append(BlueprintAttribute("workflowInputVariationSlots","sima/workflow/WorkflowInputSlot","",True,Dimension("size","")))