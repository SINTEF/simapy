...
class PostProcessorOperationNodeBlueprint(RunNodeBlueprint):
    ...
    def __init__(self, name="PostProcessorOperationNode", package_path="sima/workflow", description=""):
        ...
        self.attributes.append(BlueprintAttribute("nodes","sima/post/OperationNode","",True,Dimension("size","")))
        ...
        self.attributes.append(BlueprintAttribute("operationOutputSlots","sima/workflow/OperationOutputSlot","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("operationInputSlots","sima/workflow/OperationInputSlot","",True,Dimension("size","")))