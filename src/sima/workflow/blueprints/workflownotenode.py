# 
# Generated with WorkflowNoteNodeBlueprint
...
class WorkflowNoteNodeBlueprint(RunNodeBlueprint):
    """"""

    def __init__(self, name="WorkflowNoteNode", package_path="sima/workflow", description=""):
