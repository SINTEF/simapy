# 
# Generated with OutputLinkBlueprint
...
class OutputLinkBlueprint(RunNodeBlueprint):
    """"""

    def __init__(self, name="OutputLink", package_path="sima/workflow", description=""):
        ...
        self.add_attribute(Attribute("linkId","string","",default=None))
