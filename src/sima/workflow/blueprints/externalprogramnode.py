...
class ExternalProgramNodeBlueprint(RunNodeBlueprint):
    ...
    def __init__(self, name="ExternalProgramNode", package_path="sima/workflow", description=""):
        ...
        self.attributes.append(BlueprintAttribute("fileInputSlots","sima/workflow/FileInputSlot","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("fileOutputSlots","sima/workflow/FileOutputSlot","",True,Dimension("size","")))
