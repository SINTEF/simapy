...
class ExternalProgramNodeBlueprint(RunNodeBlueprint):
    ...
    def __init__(self, name="ExternalProgramNode", package_path="sima/workflow", description=""):
        ...
        self.add_attribute(Attribute("environmentVariables","string","Environment variables to set when executing. Separate each variable with a semicolon and path segments with colon.",default=None))