...
class ConditionInputNodeBlueprint(RunNodeBlueprint):
    ...
    def __init__(self, name="ConditionInputNode", package_path="sima/workflow", description=""):
        ...
        self.attributes.append(BlueprintAttribute("additionalFiles","sima/workflow/FileSpecification","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("modelOutput","sima/workflow/ModelOutputSpecification","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("modelInputSlots","sima/workflow/ModelInputSlot","",True,Dimension("size","")))
