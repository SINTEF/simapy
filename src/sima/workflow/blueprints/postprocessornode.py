...
class PostProcessorNodeBlueprint(RunNodeBlueprint):
    ...
    def __init__(self, name="PostProcessorNode", package_path="sima/workflow", description=""):
        ...
        self.attributes.append(BlueprintAttribute("postOutputSlots","sima/workflow/PostprocessorOutputSlot","",True,Dimension("*")))
        self.attributes.append(BlueprintAttribute("postInputSlots","sima/workflow/PostprocessorInputSlot","",True,Dimension("*")))