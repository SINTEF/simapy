...
class TextInput(ValueInputNode):
    ...
    def __init__(self , name:str="", description:str="", _id:str="", x:int=0, y:int=0, h:int=0, w:int=0, root:str="", resultId:str="", specifyAdditionalProperties:bool=False, value:str="", array:bool=False, **kwargs):
