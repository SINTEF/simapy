...
# 
# Generated with InputLink
from typing import Dict,Sequence,List
from dmt.entity import Entity
from dmt.blueprint import Blueprint
from .blueprints.inputlink import InputLinkBlueprint
from sima.post.controlsignalinputslot import ControlSignalInputSlot
from sima.post.outputslot import OutputSlot
from sima.post.runnode import RunNode
from sima.sima.scriptablevalue import ScriptableValue

class InputLink(RunNode):
    """
    Keyword arguments
    -----------------
    name : str
    ...
    def __init__(self , name:str="", description:str="", _id:str="", x:int=0, y:int=0, h:int=0, w:int=0, linkId:str="", root:str="", **kwargs):
