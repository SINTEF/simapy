...
class WamitCalculationParameters(MOAO):
    ...
    def __init__(self , name:str="", description:str="", _id:str="", solveRadiationProblem:YesNoOption=YesNoOption.NO, solveDiffractionProblem:PotenProblemOption=PotenProblemOption.YESFORALL, calculateAddedMassAndDampingCoefficients:YesNoOption=YesNoOption.NO, calculateExcitingForcesFromHaskindRelations:CalculateExcitingForcesOption=CalculateExcitingForcesOption.NO, calculateExcitingForcesFromDiffractionPotential:CalculateExcitingForcesOption=CalculateExcitingForcesOption.NO, calculateResponseAmplitudeOperator:CalculateResponseAmplitudeOperatorOption=CalculateResponseAmplitudeOperatorOption.NO, useMomentumIntegration:CalculateMeanForceAndMomentIntegrationOption=CalculateMeanForceAndMomentIntegrationOption.NO, usePressureIntegration:CalculateMeanForceAndMomentIntegrationOption=CalculateMeanForceAndMomentIntegrationOption.NO, useControlSurfaceIntegration:CalculateMeanForceAndMomentIntegrationOption=CalculateMeanForceAndMomentIntegrationOption.NO, methodForSolvingLinearSystems:LinearSystemSolvingMethod=LinearSystemSolvingMethod.ITERATIVE, numberOfBlocksInBlockIterativeSolver:int=2, geometryMethod:GeometryOrderOption=GeometryOrderOption.LOW, integrateLogarithmicSingularitySeparately:YesNoOption=YesNoOption.NO, panelSize:float=10.0, evaluateSourceStrength:YesNoOption=YesNoOption.NO, calculationOfDiffractionPotential:DiffractionPotentailOption=DiffractionPotentailOption.DIFFRACTION, useInfiniteWaterDepth:bool=True, maximumNumberOfIterations:int=35, maxNumOfIterationsAdaptiveIntegrationMomentum:int=8, generateReport:bool=False, briefOverviewOfTheory:bool=False, taskDescription:bool=False, wavePeriodsAndHeadings:bool=False, calculationParameters:bool=False, hydrostaticResults:bool=False, structuralMass:bool=False, externalStiffnessMatrix:bool=False, linearDampingMatrix:bool=False, firstOrderMotionTransferFunction:bool=False, firstOrderWaveForceTransferFunctionDiffraction:bool=False, firstOrderWaveForceTransferFunctionHaskind:bool=False, addedMassZeroFrequency:bool=False, addedMassInfiniteFrequency:bool=False, frequencyDependentAddedMass:bool=False, frequencyDependentDamping:bool=False, diffractedWaveField:bool=False, waveDriftForcePressure:bool=False, waveDriftForceMomentum:bool=False, waveDriftForceControlSurfaceIntegration:bool=False, runPotenOnceInConditionSetsAndSpaces:bool=False, ignoreExitCode:bool=False, **kwargs):
        super().__init__(**kwargs)
        self.__name = name
        self.__description = description
        self.___id = _id
        self.__scriptableValues = list()
        self.__solveRadiationProblem = solveRadiationProblem
        self.__solveDiffractionProblem = solveDiffractionProblem
        self.__calculateAddedMassAndDampingCoefficients = calculateAddedMassAndDampingCoefficients
        self.__calculateExcitingForcesFromHaskindRelations = calculateExcitingForcesFromHaskindRelations
        self.__calculateExcitingForcesFromDiffractionPotential = calculateExcitingForcesFromDiffractionPotential
        self.__calculateResponseAmplitudeOperator = calculateResponseAmplitudeOperator
        self.__useMomentumIntegration = useMomentumIntegration
        self.__usePressureIntegration = usePressureIntegration
        self.__pointField = list()
        self.__useControlSurfaceIntegration = useControlSurfaceIntegration
        self.__methodForSolvingLinearSystems = methodForSolvingLinearSystems
        self.__numberOfBlocksInBlockIterativeSolver = numberOfBlocksInBlockIterativeSolver
        self.__geometryMethod = geometryMethod
        self.__integrateLogarithmicSingularitySeparately = integrateLogarithmicSingularitySeparately
        self.__panelSize = panelSize
        self.__evaluateSourceStrength = evaluateSourceStrength
        self.__calculationOfDiffractionPotential = calculationOfDiffractionPotential
        self.__fieldPoints = list()
        self.__useInfiniteWaterDepth = useInfiniteWaterDepth
        self.__maximumNumberOfIterations = maximumNumberOfIterations
        self.__maxNumOfIterationsAdaptiveIntegrationMomentum = maxNumOfIterationsAdaptiveIntegrationMomentum
        self.__generateReport = generateReport
        self.__briefOverviewOfTheory = briefOverviewOfTheory
        self.__taskDescription = taskDescription
        self.__wavePeriodsAndHeadings = wavePeriodsAndHeadings
        self.__calculationParameters = calculationParameters
        self.__hydrostaticResults = hydrostaticResults
        self.__structuralMass = structuralMass
        self.__externalStiffnessMatrix = externalStiffnessMatrix
        self.__linearDampingMatrix = linearDampingMatrix
        self.__firstOrderMotionTransferFunction = firstOrderMotionTransferFunction
        self.__firstOrderWaveForceTransferFunctionDiffraction = firstOrderWaveForceTransferFunctionDiffraction
        self.__firstOrderWaveForceTransferFunctionHaskind = firstOrderWaveForceTransferFunctionHaskind
        self.__addedMassZeroFrequency = addedMassZeroFrequency
        self.__addedMassInfiniteFrequency = addedMassInfiniteFrequency
        self.__frequencyDependentAddedMass = frequencyDependentAddedMass
        self.__frequencyDependentDamping = frequencyDependentDamping
        self.__diffractedWaveField = diffractedWaveField
        self.__waveDriftForcePressure = waveDriftForcePressure
        self.__waveDriftForceMomentum = waveDriftForceMomentum
        self.__waveDriftForceControlSurfaceIntegration = waveDriftForceControlSurfaceIntegration
        self.__runPotenOnceInConditionSetsAndSpaces = runPotenOnceInConditionSetsAndSpaces
