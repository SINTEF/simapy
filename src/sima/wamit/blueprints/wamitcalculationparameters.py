...
class WamitCalculationParametersBlueprint(MOAOBlueprint):
    ...
    def __init__(self, name="WamitCalculationParameters", package_path="sima/wamit", description=""):
        ...
        self.attributes.append(BlueprintAttribute("pointField","sima/wamit/PointField","",True,Dimension("size","")))
        ...
        self.attributes.append(BlueprintAttribute("fieldPoints","sima/sima/Point3","",True,Dimension("size","")))
