...
class WamitModelBlueprint(MOAOBlueprint):
    ...
    def __init__(self, name="WamitModel", package_path="sima/wamit", description=""):
        ...
        self.attributes.append(BlueprintAttribute("environments","sima/wamit/WamitEnvironment","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("location","sima/wamit/WamitLocation","",True))
        self.attributes.append(BlueprintAttribute("bodies","sima/wamit/WamitBody","",True,Dimension("size","")))
