...
class WamitLocationBlueprint(LocationBlueprint):
    ...
    def __init__(self, name="WamitLocation", package_path="sima/wamit", description=""):
        ...
        self.add_attribute(Attribute("gridZone","string","Zone consists of a number from [01-60] and a letter from [C-Z], or just one of [A,B,Y,Z] if on the antarctic or arctic pole.",default=None))
