...
class WamitLocationBlueprint(LocationBlueprint):
    ...
    def __init__(self, name="WamitLocation", package_path="sima/wamit", description=""):
        ...
        self.attributes.append(BlueprintAttribute("seaSurface","sima/wamit/SeaSurface","",True))
        self.attributes.append(BlueprintAttribute("physicalConstants","sima/wamit/PhysicalConstants","",True))