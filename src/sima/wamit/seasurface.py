...
class SeaSurface(MOAO):
    ...
    def __init__(self , name:str="", description:str="", _id:str="", centerX:float=0.0, centerY:float=0.0, sizeX:float=500.0, sizeY:float=500.0, transparency:float=0.0, meshGridSize:float=100.0, showMesh:bool=True, z:float=-100.0, **kwargs):
