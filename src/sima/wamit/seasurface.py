...
class SeaSurface(MOAO):
    ...
    def __init__(self , name="", description="", _id="", centerX=0.0, centerY=0.0, sizeX=500.0, sizeY=500.0, transparency=0.0, meshGridSize=100.0, showMesh=True, z=-100.0, **kwargs):
