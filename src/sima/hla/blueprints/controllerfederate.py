...
class ControllerFederateBlueprint(HLAFederateBlueprint):
    ...
    def __init__(self, name="ControllerFederate", package_path="sima/hla", description=""):
        ...
        self.attributes.append(BlueprintAttribute("allHLAControlConfigurations","sima/hla/HLAControlConfiguration","",True,Dimension("*")))
        self.attributes.append(BlueprintAttribute("winchGroups","sima/hla/HLAWinchGroup","",True,Dimension("*")))