# 
# Generated with HLASeaSurfaceBlueprint
...
class HLASeaSurfaceBlueprint(MOAOBlueprint):
    """"""

    def __init__(self, name="HLASeaSurface", package_path="sima/hla", description=""):
        ...
        self.add_attribute(Attribute("lcWaveLength","number","Length of long-crested wave field",default=300.0))
        self.add_attribute(Attribute("lcWaveWidth","number","Width of long-crested wave field",default=100.0))
        self.add_attribute(Attribute("lcWaveNumPoints","integer","Number of points in long-crested wave field",default=61))