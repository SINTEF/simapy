# 
# Generated with HLAROVBlueprint
from dmt.blueprint import Blueprint
from dmt.dimension import Dimension
from dmt.attribute import Attribute
from dmt.enum_attribute import EnumAttribute
from dmt.blueprint_attribute import BlueprintAttribute
from .hlabody import HLABodyBlueprint

class HLAROVBlueprint(HLABodyBlueprint):
    """"""

    def __init__(self, name="HLAROV", package_path="sima/hla", description=""):
        ...
        self.attributes.append(BlueprintAttribute("viewpoints","sima/hla/HLABodyViewpoint","",True,Dimension("size","")))