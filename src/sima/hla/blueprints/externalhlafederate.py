...
class ExternalHLAFederateBlueprint(HLAFederateBlueprint):
    ...
    def __init__(self, name="ExternalHLAFederate", package_path="sima/hla", description=""):
        ...
        self.add_attribute(Attribute("jarFile","string","Path to jar file",default=None))
        self.add_attribute(Attribute("className","string","Class name starting HLAFederate",default=None))
        self.add_attribute(Attribute("classPath","string","Additional classpath needed by the external jar",default=None))
        self.add_attribute(Attribute("arguments","string","Arguments passed to the class' main function",default=None))
        self.add_attribute(Attribute("libraryPath","string","Sometimes needed when using native libraries. Corresponds to the -Djava.library.path argument",default=None))
