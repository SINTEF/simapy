...
class HLATaskBlueprint(TaskBlueprint):
    ...
    def __init__(self, name="HLATask", package_path="sima/hla", description=""):
        ...
        self.attributes.append(BlueprintAttribute("federates","sima/hla/HLAFederate","",True,Dimension("size","")))
        ...
        self.attributes.append(BlueprintAttribute("dataTables","sima/hla/HLADataTable","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("plots","sima/hla/HLASignalPlot","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("controlPanels","sima/hla/ControlPanel","",True,Dimension("size","")))