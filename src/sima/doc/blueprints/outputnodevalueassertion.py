...
class OutputNodeValueAssertionBlueprint(MOAOBlueprint):
    ...
    def __init__(self, name="OutputNodeValueAssertion", package_path="sima/doc", description=""):
        ...
        self.add_attribute(Attribute("message","string","",default=None))
        ...
        self.add_attribute(Attribute("expectedValue","string","When expected value is a number, the number of significant digits will be used as a tolerance level",default=None))
