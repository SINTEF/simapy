...
class ConditionTestBlueprint(TestBlueprint):
    ...
    def __init__(self, name="ConditionTest", package_path="sima/doc", description=""):
        ...
        self.attributes.append(BlueprintAttribute("assertions","sima/doc/OutputNodeValueAssertion","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("comparisons","sima/doc/ComparisonAssertion","",True,Dimension("size","")))
