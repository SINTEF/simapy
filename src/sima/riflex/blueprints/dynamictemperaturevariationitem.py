...
class DynamicTemperatureVariationItemBlueprint(ElementReferenceBlueprint):
    ...
    def __init__(self, name="DynamicTemperatureVariationItem", package_path="sima/riflex", description=""):
        ...
        self.attributes.append(Attribute("startTime","number","Start time for temperature variation",default=0.0))
        self.attributes.append(Attribute("endTime","number","End time for temperature variation",default=0.0))
        self.attributes.append(Attribute("lastTemperature","number","Temperature at end of temperature variation",default=0.0))