# 
# Generated with ResFileBlueprint
...
class ResFileBlueprint(ResultBlueprint):
    """"""

    def __init__(self, name="ResFile", package_path="sima/riflex", description=""):
        ...
        self.add_attribute(Attribute("version","string","",default=None))