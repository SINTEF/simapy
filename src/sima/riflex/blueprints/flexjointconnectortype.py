...
class FlexJointConnectorTypeBlueprint(NodalComponentTypeBlueprint):
    ...
    def __init__(self, name="FlexJointConnectorType", package_path="sima/riflex", description=""):
        ...
        self.attributes.append(BlueprintAttribute("stiffnessCharacteristicsRotX","sima/riflex/RotationalStiffnessItem","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("stiffnessCharacteristicsRotY","sima/riflex/RotationalStiffnessItem","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("stiffnessCharacteristicsRotZ","sima/riflex/RotationalStiffnessItem","",True,Dimension("size","")))