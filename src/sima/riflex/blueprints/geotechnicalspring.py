...
class GeotechnicalSpringBlueprint(NodeReferenceBlueprint,NamedObjectBlueprint):
    ...
    def __init__(self, name="GeotechnicalSpring", package_path="sima/riflex", description=""):
        ...
        self.attributes.append(BlueprintAttribute("stiffnessItems","sima/riflex/GeotechnicalSpringStiffnessItem","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("dampingDisplacementItems","sima/riflex/DampingDisplacementItem","",True,Dimension("size","")))
