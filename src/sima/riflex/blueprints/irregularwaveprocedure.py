...
class IrregularWaveProcedureBlueprint(MOAOBlueprint):
    ...
    def __init__(self, name="IrregularWaveProcedure", package_path="sima/riflex", description=""):
        ...
        self.attributes.append(BlueprintAttribute("waveKinematicDiffPoints","sima/riflex/WaveKinematicsDiffPoint","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("waveKinematicNodePoints","sima/riflex/WaveKinematicsNodePoint","",True,Dimension("size","")))
        ...
        self.attributes.append(BlueprintAttribute("waveKinematicsTimeSeriesReferences","sima/riflex/WaveKinematicsTimeSeriesReference","",True,Dimension("size","")))
