...
class RIFLEXVivanaCalculationParametersBlueprint(MOAOBlueprint):
    ...
    def __init__(self, name="RIFLEXVivanaCalculationParameters", package_path="sima/riflex", description=""):
        ...
        self.attributes.append(BlueprintAttribute("hydrodynamicCrossSectionProperties","sima/riflex/HydrodynamicCrossSectionProperties","",True,Dimension("*")))
        self.attributes.append(BlueprintAttribute("excitationZoneProperties","sima/riflex/ExcitationZoneProperty","",True,Dimension("*")))
        self.attributes.append(BlueprintAttribute("addedMassProperties","sima/riflex/AddedMassProperty","",True,Dimension("*")))
        self.attributes.append(BlueprintAttribute("excitationCoefficientProperties","sima/riflex/ExcitationCoefficientsProperty","",True,Dimension("*")))
        self.attributes.append(BlueprintAttribute("dampingFactorProperties","sima/riflex/DampingFactorProperty","",True,Dimension("*")))
        self.attributes.append(BlueprintAttribute("strouhalSpecificationProperties","sima/riflex/StrouhalSpecificationProperty","",True,Dimension("*")))
