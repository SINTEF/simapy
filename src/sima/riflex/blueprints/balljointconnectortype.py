...
class BallJointConnectorTypeBlueprint(NodalComponentTypeBlueprint):
    ...
    def __init__(self, name="BallJointConnectorType", package_path="sima/riflex", description=""):
        ...
        self.add_attribute(EnumAttribute("boundaryRotX","sima/riflex/BoundaryCondition","Rotation freedom code, x-axis."))
        self.add_attribute(EnumAttribute("boundaryRotY","sima/riflex/BoundaryCondition","Rotation freedom code, y-axis."))
        self.add_attribute(EnumAttribute("boundaryRotZ","sima/riflex/BoundaryCondition","Rotation freedom code, z-axis."))