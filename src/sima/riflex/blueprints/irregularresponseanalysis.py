...
class IrregularResponseAnalysisBlueprint(MOAOBlueprint):
    ...
    def __init__(self, name="IrregularResponseAnalysis", package_path="sima/riflex", description=""):
        ...
        self.attributes.append(BlueprintAttribute("supportVesselMotionScalingItems","sima/riflex/SupportVesselMotionScalingItem","",True,Dimension("size","")))
        ...
        self.attributes.append(BlueprintAttribute("wfMotionTimeSeries","sima/riflex/WFMotionTimeSeries","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("lfMotionTimeSeries","sima/riflex/LFMotionTimeSeries","",True,Dimension("size","")))