...
class RIFLEXStaticCalculationParametersBlueprint(MOAOBlueprint):
    ...
    def __init__(self, name="RIFLEXStaticCalculationParameters", package_path="sima/riflex", description=""):
        ...
        self.attributes.append(BlueprintAttribute("loadTypeItems","sima/riflex/StaticLoadTypeItem","",True,Dimension("*")))
        ...
        self.attributes.append(BlueprintAttribute("staticLoadComponents","sima/riflex/StaticLoadComponent","",True,Dimension("*")))
