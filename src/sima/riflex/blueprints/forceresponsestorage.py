...
class ForceResponseStorageBlueprint(MOAOBlueprint):
    ...
    def __init__(self, name="ForceResponseStorage", package_path="sima/riflex", description=""):
        ...
        self.attributes.append(BlueprintAttribute("elements","sima/riflex/ElementReference","Specification of nodes for displacement storage",True,Dimension("size","")))
        ...
        self.attributes.append(BlueprintAttribute("relativeElementAngles","sima/riflex/RelativeElementAngle","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("elementAngles","sima/riflex/ElementAngle","",True,Dimension("size","")))
