# 
# Generated with NodeReferenceBlueprint
...
class NodeReferenceBlueprint(SegmentReferenceBlueprint):
    """"""

    def __init__(self, name="NodeReference", package_path="sima/riflex", description=""):
