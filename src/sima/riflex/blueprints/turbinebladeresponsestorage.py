...
class TurbineBladeResponseStorageBlueprint(MOAOBlueprint):
    ...
    def __init__(self, name="TurbineBladeResponseStorage", package_path="sima/riflex", description=""):
        ...
        self.attributes.append(BlueprintAttribute("elements","sima/riflex/ElementReference","Specification of elements for turbine blade response storage",True,Dimension("*")))