...
class WFMotionTimeSeriesBlueprint(MOAOBlueprint):
    ...
    def __init__(self, name="WFMotionTimeSeries", package_path="sima/riflex", description=""):
        ...
        self.add_attribute(Attribute("zMotionColumn","integer","Column or time series number for global dynamic z-motion",default=0))
        self.add_attribute(Attribute("zMotionVersion","integer","Startimes version number for global dynamic z-motion",default=0))
        self.add_attribute(Attribute("xRotationColumn","integer","Column or time series number for global dynamic x-rotation",default=0))
        self.add_attribute(Attribute("xRotationVersion","integer","Startimes version number for global dynamic x-rotation",default=0))
        self.add_attribute(Attribute("yRotationColumn","integer","Column or time series number for global dynamic y-rotation",default=0))
        self.add_attribute(Attribute("yRotationVersion","integer","Startimes version number for global dynamic y-rotation",default=0))