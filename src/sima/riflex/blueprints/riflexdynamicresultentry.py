...
class RIFLEXDynamicResultEntryBlueprint(SIMODynamicResultEntryBlueprint):
    ...
    def __init__(self, name="RIFLEXDynamicResultEntry", package_path="sima/riflex", description=""):
        ...
        self.attributes.append(BlueprintAttribute("combinedLoadingResuls","sima/sima/Result","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("outmodResuls","sima/sima/Result","",True,Dimension("size","")))