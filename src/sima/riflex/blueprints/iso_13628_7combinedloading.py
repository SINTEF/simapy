...
class ISO_13628_7CombinedLoadingBlueprint(CombinedLoadingBlueprint):
    ...
    def __init__(self, name="ISO_13628_7CombinedLoading", package_path="sima/riflex", description=""):
        ...
        self.attributes.append(BlueprintAttribute("properties","sima/riflex/CombinedLoadingProperties","Specification of nodes for displacement storage",True,Dimension("size","")))
