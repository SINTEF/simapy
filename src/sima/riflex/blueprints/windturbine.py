...
class WindTurbineBlueprint(NamedObjectBlueprint):
    ...
    def __init__(self, name="WindTurbine", package_path="sima/riflex", description=""):
        ...
        self.attributes.append(BlueprintAttribute("blades","sima/riflex/BladeItem","",True,Dimension("size","")))
        ...
        self.attributes.append(BlueprintAttribute("measurementNodes","sima/riflex/MeasurementNode","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("measurementElements","sima/riflex/MeasurementElement","",True,Dimension("size","")))
