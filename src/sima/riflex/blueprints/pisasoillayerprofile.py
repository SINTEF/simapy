...
class PisaSoilLayerProfileBlueprint(SoilLayerProfileBlueprint):
    ...
    def __init__(self, name="PisaSoilLayerProfile", package_path="sima/riflex", description=""):
        ...
        self.attributes.append(BlueprintAttribute("soilLayers","sima/riflex/PisaSoilLayer","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("embeddedLines","sima/riflex/PisaLineItem","",True,Dimension("size","")))