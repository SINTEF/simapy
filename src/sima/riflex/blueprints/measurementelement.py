# 
# Generated with MeasurementElementBlueprint
...
class MeasurementElementBlueprint(ElementReferenceBlueprint):
    """"""

    def __init__(self, name="MeasurementElement", package_path="sima/riflex", description=""):
