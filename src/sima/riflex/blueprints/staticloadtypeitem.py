...
class StaticLoadTypeItemBlueprint(MOAOBlueprint):
    ...
    def __init__(self, name="StaticLoadTypeItem", package_path="sima/riflex", description=""):
        ...
        self.attributes.append(BlueprintAttribute("temperatureVariations","sima/riflex/TemperatureVariationItem","",True,Dimension("*")))
        self.attributes.append(BlueprintAttribute("pressureVariations","sima/riflex/PressureVariationItem","",True,Dimension("*")))
        self.attributes.append(BlueprintAttribute("winchVariations","sima/riflex/WinchVariationItem","",True,Dimension("*")))
