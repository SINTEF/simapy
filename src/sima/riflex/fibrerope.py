...
class FibreRope(CrossSection,CRSAxialFrictionModel):
    ...
    def __init__(self , name:str="", description:str="", _id:str="", staticFriction:float=0.0, staticElongation:float=0.0, dynamicFriction:float=0.0, dynamicElongation:float=0.0, axialFriction:bool=False, scfkSpecification:bool=True, loadFormulation:LoadFormulation=LoadFormulation.MORISON, hydrodynamicDiameter:float=0.0, addedMassTanDir:float=0.0, addedMassNormDir:float=0.0, dampingNormDir:float=0.0, cdt:float=0.0, cdn:float=0.0, cmt:float=0.0, cmn:float=0.0, cdtl:float=0.0, cdnl:float=0.0, cdx:float=0.0, cdy:float=0.0, amx:float=0.0, amy:float=0.0, cdlx:float=0.0, cdly:float=0.0, hydrodynamicInputCode:HydrodynamicInputCode=HydrodynamicInputCode.DIMENSIONAL, scfk:float=1.0, scfkt:TangentialFroudeKrylovScaling=TangentialFroudeKrylovScaling.ON, massDampingSpecification:bool=False, stiffnessDampingSpecification:bool=False, axialDampingSpecification:bool=False, temperature:float=0.0, alpha:float=0.0, beta:float=0.0, defaultExpansion:bool=True, cdax:float=0.0, cday:float=0.0, cdaz:float=0.0, aerodynamicInputCode:AerodynamicInputCode=AerodynamicInputCode.NONE, aerodynamicDiameter:float=0.0, tensionCapacity:float=0.0, maxCurvature:float=0.0, submerged:bool=False, tmax:float=0.0, **kwargs):
        ...
        self.__massVolume = FibreRopeMassVolume()
