...
# 
# Generated with SupportVesselForceStorage
...
class SupportVesselForceStorage(MOAO):
    ...
    items : List[SupportVesselForceStorageItem]
    timeInterval : float
         (default 0.0)
    """

    def __init__(self , name:str="", description:str="", _id:str="", timeInterval:float=0.0, **kwargs):
    ...
    def blueprint(self) -> Blueprint:
        ...
        return SupportVesselForceStorageBlueprint()
    ...
    @property
    def items(self) -> List[SupportVesselForceStorageItem]:
        """"""
        return self.__items
