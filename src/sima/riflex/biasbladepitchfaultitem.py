...
class BiasBladePitchFaultItem(MOAO):
    ...
    def __init__(self , name:str="", description:str="", _id:str="", startTime:float=0.0, pitchDeviation:float=0.0, rampDuration:float=0.0, **kwargs):
        ...
        self.__line = None
        self.__pitchDeviation = pitchDeviation
