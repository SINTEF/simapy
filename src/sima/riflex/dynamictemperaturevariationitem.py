...
# 
# Generated with DynamicTemperatureVariationItem
from __future__ import annotations
from typing import Dict,Sequence,List
from dmt.entity import Entity
from dmt.blueprint import Blueprint
from .blueprints.dynamictemperaturevariationitem import DynamicTemperatureVariationItemBlueprint
...
class DynamicTemperatureVariationItem(ElementReference):
    """
    Keyword arguments
    -----------------
    name : str
    ...
    startTime : float
         Start time for temperature variation(default 0.0)
    endTime : float
         End time for temperature variation(default 0.0)
    lastTemperature : float
         Temperature at end of temperature variation(default 0.0)
    """

    def __init__(self , name:str="", description:str="", _id:str="", segment:int=1, allSegments:bool=False, elementNumber:int=1, allElements:bool=False, startTime:float=0.0, endTime:float=0.0, lastTemperature:float=0.0, **kwargs):
        ...
        self.__lastTemperature = lastTemperature
    ...
    def blueprint(self) -> Blueprint:
        ...
        return DynamicTemperatureVariationItemBlueprint()
    ...
    def startTime(self) -> float:
        """Start time for temperature variation"""
    ...
    def endTime(self) -> float:
        """End time for temperature variation"""
    ...
    @property
    def lastTemperature(self) -> float:
        """Temperature at end of temperature variation"""
        return self.__lastTemperature

    @lastTemperature.setter
    def lastTemperature(self, value: float):
        """Set lastTemperature"""
        self.__lastTemperature = float(value)
