...
class DynamicTemperatureVariationItem(ElementReference):
    ...
    def __init__(self , description="", _id=None, segment=1, allSegments=False, elementNumber=1, allElements=False, startTime=0.0, endTime=0.0, lastTemperature=0.0, **kwargs):
