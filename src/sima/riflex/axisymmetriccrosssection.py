...
class AxisymmetricCrossSection(CrossSection,CRSAxialFrictionModel,TimeDomainVIVLoadCoefficients):
    ...
    def __init__(self , name:str="", description:str="", _id:str="", staticFriction:float=0.0, staticElongation:float=0.0, dynamicFriction:float=0.0, dynamicElongation:float=0.0, axialFriction:bool=False, vivLoadFormulation:VIVLoadFormulation=VIVLoadFormulation.CROSSFLOW_VIV_ONLY, cv:float=0.0, fnull:float=0.0, fmin:float=0.0, fmax:float=0.0, nmem:int=500, cvil:float=0.0, alphil:float=0.0, chh:float=0.0, fnullil:float=0.0, fminil:float=0.0, fmaxil:float=0.0, scfkSpecification:bool=True, loadFormulation:LoadFormulation=LoadFormulation.MORISON, hydrodynamicDiameter:float=0.0, addedMassTanDir:float=0.0, addedMassNormDir:float=0.0, dampingNormDir:float=0.0, cdt:float=0.0, cdn:float=0.0, cmt:float=0.0, cmn:float=0.0, cdtl:float=0.0, cdnl:float=0.0, cdx:float=0.0, cdy:float=0.0, amx:float=0.0, amy:float=0.0, cdlx:float=0.0, cdly:float=0.0, hydrodynamicInputCode:HydrodynamicInputCode=HydrodynamicInputCode.DIMENSIONAL, scfk:float=1.0, scfkt:TangentialFroudeKrylovScaling=TangentialFroudeKrylovScaling.ON, massDampingSpecification:bool=False, stiffnessDampingSpecification:bool=False, axialDampingSpecification:bool=False, temperature:float=0.0, alpha:float=0.0, beta:float=0.0, defaultExpansion:bool=True, cdax:float=0.0, cday:float=0.0, cdaz:float=0.0, aerodynamicInputCode:AerodynamicInputCode=AerodynamicInputCode.NONE, aerodynamicDiameter:float=0.0, axialStiffnessInput:AxialStiffness=AxialStiffness.CONSTANT, bendingStiffnessInput:BendingStiffness=BendingStiffness.CONSTANT, torsionStiffnessInput:TorsionStiffness=TorsionStiffness.CONSTANT, pressureDependency:int=0, hysteresisOption:Hysteresis=Hysteresis.NO_HYSTERESIS, hardeningParameter:float=0.0, axialStiffness:float=0.0, bendingStiffness:float=0.0, intFrictionMoment:float=0.0, shearStiffness:float=0.0, negativeTorsionStiffness:float=0.0, positiveTorsionStiffness:float=0.0, tensionCapacity:float=0.0, maxCurvature:float=0.0, barBeam:BarBeam=BarBeam.BAR, stiffnessFactor:float=10.0, submerged:bool=False, coupledBendingTorsion:bool=False, hydrodynamicRadiationInputCode:HydrodynamicRadiationInputCode=HydrodynamicRadiationInputCode.DIMENSIONAL, solidityRatio:float=0.0, netWidthEnd1:float=0.0, netWidthEnd2:float=0.0, currentVelocityScaling:float=1.0, **kwargs):
        ...
        self.__massVolume = AxisymmetricCrossSectionMassVolume()
        ...
        self.__hysteresisOption = hysteresisOption
        self.__hardeningParameter = hardeningParameter
        self.__axialStiffness = axialStiffness
        self.__axialStiffnessCharacteristics = list()
        self.__bendingStiffness = bendingStiffness
        self.__intFrictionMoment = intFrictionMoment
        self.__shearStiffness = shearStiffness
        ...
        self.__stiffnessFactor = stiffnessFactor
        ...
        self.__currentVelocityScaling = currentVelocityScaling
