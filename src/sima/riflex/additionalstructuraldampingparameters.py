...
class AdditionalStructuralDampingParameters(MOAO):
    ...
    def __init__(self , name:str="", description:str="", _id:str="", globalSegmentNumber:int=0, structuralDampingFile:str="", **kwargs):
        super().__init__(**kwargs)
        self.__name = name
        self.__description = description
        self.___id = _id
        self.__scriptableValues = list()
        self.__globalSegmentNumber = globalSegmentNumber
        self.__structuralDampingFile = structuralDampingFile
