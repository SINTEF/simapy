...
class NodalBodyType(NodalComponentType):
    ...
    def __init__(self , name:str="", description:str="", _id:str="", mass:float=0.0, volume:float=0.0, referenceFrame:ReferenceFrameType=ReferenceFrameType.LOCAL, dragX:float=0.0, dragY:float=0.0, dragZ:float=0.0, addedMassX:float=0.0, addedMassY:float=0.0, addedMassZ:float=0.0, **kwargs):
