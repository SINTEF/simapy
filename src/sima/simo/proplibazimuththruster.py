...
class ProplibAzimuthThruster(IThruster):
    ...
    def __init__(self , name:str="", description:str="", _id:str="", minForce:float=0.0, maxForce:float=0.0, force:float=0.0, forceDirection:float=0.0, includeSurfaceProximityLoss:bool=True, includeThrusterHullInteraction:bool=True, includeThrusterThrusterInteraction:bool=True, maxRps:float=0.0, diameter:float=0.0, bladeAreaRatio:float=0.0, wakeFraction:float=0.0, thrustDeductionFactor:float=0.0, sigma:float=0.0, podArea:float=0.0, pitchRatio:float=0.0, bilgeRadius:float=0.0, verticalDistanceHull:float=0.0, **kwargs):
