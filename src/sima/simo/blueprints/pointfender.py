# 
# Generated with PointFenderBlueprint
...
class PointFenderBlueprint(NamedObjectBlueprint):
    """"""

    def __init__(self, name="PointFender", package_path="sima/simo", description=""):
        ...
        self.attributes.append(BlueprintAttribute("pointBody","sima/simo/SIMOBody","",False))
        self.attributes.append(BlueprintAttribute("planeBody","sima/simo/SIMOBody","",False))
        self.attributes.append(BlueprintAttribute("contactPoints","sima/sima/Point3","",True,Dimension("size","")))