...
class PointFenderBlueprint(NamedObjectBlueprint):
    ...
    def __init__(self, name="PointFender", package_path="sima/simo", description=""):
        ...
        self.add_attribute(BlueprintAttribute("pointBody","sima/simo/SIMOBody","",False))
        self.add_attribute(BlueprintAttribute("planeBody","sima/simo/SIMOBody","",False))
        self.add_attribute(BlueprintAttribute("contactPoints","sima/sima/Point3","",True,Dimension("*")))