...
class GenericExternalControlSystemBlueprint(NamedObjectBlueprint):
    ...
    def __init__(self, name="GenericExternalControlSystem", package_path="sima/simo", description=""):
        ...
        self.attributes.append(BlueprintAttribute("measurementEntities","sima/simo/SignalEntity","",True,Dimension("*")))
        self.attributes.append(BlueprintAttribute("feedbackEntities","sima/simo/SignalEntity","",True,Dimension("*")))
