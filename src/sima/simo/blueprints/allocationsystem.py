...
class AllocationSystemBlueprint(MOAOBlueprint):
    ...
    def __init__(self, name="AllocationSystem", package_path="sima/simo", description=""):
        ...
        self.attributes.append(BlueprintAttribute("thrusters","sima/simo/ThrusterAllocation","",True,Dimension("size","")))
        ...
        self.attributes.append(BlueprintAttribute("thrusterControls","sima/simo/ThrusterControl","",True,Dimension("size","")))
