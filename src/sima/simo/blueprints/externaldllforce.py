...
class ExternalDLLForceBlueprint(NamedObjectBlueprint):
    ...
    def __init__(self, name="ExternalDLLForce", package_path="sima/simo", description=""):
        ...
        self.attributes.append(BlueprintAttribute("intParameters","sima/simo/StringIntItem","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("doubleParameters","sima/simo/StringDoubleItem","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("stringParameters","sima/simo/StringItem","",True,Dimension("size","")))
