...
class SpecifiedMomentBlueprint(NamedObjectBlueprint):
    ...
    def __init__(self, name="SpecifiedMoment", package_path="sima/simo", description=""):
        ...
        self.attributes.append(Attribute("magnitude","number","Moment component magnitude parameter",default=0.0))
        self.attributes.append(Attribute("momentDerivative","number","Moment component moment derivative parameter",default=0.0))