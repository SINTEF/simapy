...
class BumperGroupBlueprint(NamedObjectBlueprint):
    ...
    def __init__(self, name="BumperGroup", package_path="sima/simo", description=""):
        ...
        self.attributes.append(BlueprintAttribute("body1Bumpers","sima/simo/BumperPart","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("body2Bumpers","sima/simo/BumperPart","",True,Dimension("size","")))