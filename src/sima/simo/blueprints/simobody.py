...
class SIMOBodyBlueprint(BodyBlueprint):
    ...
    def __init__(self, name="SIMOBody", package_path="sima/simo", description=""):
        ...
        self.add_attribute(Attribute("positionsFileName","string","File name for body positions",default=None))
        self.add_attribute(Attribute("positionsHLAObjectName","string","HLA object name for body",default=None))
