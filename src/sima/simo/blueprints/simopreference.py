...
class SIMOPreferenceBlueprint(SIMAPreferenceBlueprint):
    ...
    def __init__(self, name="SIMOPreference", package_path="sima/simo", description=""):
        ...
        self.add_attribute(Attribute("locations","string","",Dimension("*"),default=None))
        self.add_attribute(Attribute("frevesLocation","string","Freves bin folder",default=None))
        self.add_attribute(Attribute("frelinLocation","string","Frelin bin folder",default=None))