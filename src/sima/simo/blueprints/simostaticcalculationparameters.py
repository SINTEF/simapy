...
class SIMOStaticCalculationParametersBlueprint(MOAOBlueprint):
    ...
    def __init__(self, name="SIMOStaticCalculationParameters", package_path="sima/simo", description=""):
        ...
        self.attributes.append(BlueprintAttribute("eliminations","sima/simo/DOFElimination","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("eigenvalueItems","sima/simo/BodyEigenvalueItem","",True,Dimension("size","")))
        ...
        self.attributes.append(BlueprintAttribute("staticEquilibriumBody","sima/simo/StaticEquilibriumBody","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("restrainFromGlobalDOFBodies","sima/simo/DOFElimination","",True,Dimension("size","")))
