...
class ThrusterBlueprint(IThrusterBlueprint):
    ...
    def __init__(self, name="Thruster", package_path="sima/simo", description=""):
        ...
        self.attributes.append(BlueprintAttribute("reductionItems","sima/simo/ThrusterReduction","",True,Dimension("size","")))
        ...
        self.attributes.append(BlueprintAttribute("forbiddenZoneItems","sima/simo/ThrusterForbiddenZone","",True,Dimension("size","")))
        ...
        self.attributes.append(BlueprintAttribute("forwardThrustTorqueCoefficients","sima/simo/ThrustTorqueCoefficient","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("reverseThrustTorqueCoefficients","sima/simo/ThrustTorqueCoefficient","",True,Dimension("size","")))
        self.attributes.append(EnumAttribute("thrustLoss","sima/simo/ThrustLoss",""))
        self.attributes.append(BlueprintAttribute("surfaceProximityReductionFactors","sima/simo/SurfaceProximityReductionFactor","",True,Dimension("size","")))
        ...
        self.attributes.append(BlueprintAttribute("controlSequence","sima/simo/ControlSequenceItem","",True,Dimension("size","")))