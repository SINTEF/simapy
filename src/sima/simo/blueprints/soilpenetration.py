...
class SoilPenetrationBlueprint(MOAOBlueprint):
    ...
    def __init__(self, name="SoilPenetration", package_path="sima/simo", description=""):
        ...
        self.attributes.append(BlueprintAttribute("frictionElements","sima/simo/SoilFrictionElement","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("capacityElements","sima/simo/SoilCapacityElement","",True,Dimension("size","")))
