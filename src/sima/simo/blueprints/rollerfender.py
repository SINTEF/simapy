# 
# Generated with RollerFenderBlueprint
...
class RollerFenderBlueprint(NamedObjectBlueprint):
    """"""

    def __init__(self, name="RollerFender", package_path="sima/simo", description=""):
        ...
        self.attributes.append(BlueprintAttribute("axisVector","sima/sima/Vector3","",True))