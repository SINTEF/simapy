...
class SIMOFrequencyDomainCalculationBlueprint(MOAOBlueprint):
    ...
    def __init__(self, name="SIMOFrequencyDomainCalculation", package_path="sima/simo", description=""):
        ...
        self.attributes.append(BlueprintAttribute("bodies","sima/simo/FrequencyDomainBodyItem","",True,Dimension("size","")))
        ...
        self.attributes.append(BlueprintAttribute("linesToSimulate","sima/simo/FrequnecyDomainLineItem","",True,Dimension("size","")))