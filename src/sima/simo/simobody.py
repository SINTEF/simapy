...
class SIMOBody(Body):
    ...
    def __init__(self , name:str="", description:str="", _id:str="", length:float=10.0, width:float=5.0, height:float=5.0, _type:BodyType=BodyType.PRESCRIBED, positionsImportType:PositionsImportType=PositionsImportType.FIXED_POSITION, positionsFileName:str="", positionsHLAObjectName:str="", applyGravityForce:bool=False, hydrodynamicSeparationMethod:HydrodynamicSeparationMethod=HydrodynamicSeparationMethod.BW2_FILTERING, hydrodynamicFilterCutOffPeriod:float=0.0, **kwargs):
        ...
        self.___type = _type
        self.__positionsImportType = positionsImportType
        self.__positionsFileName = positionsFileName
        self.__positionsHLAObjectName = positionsHLAObjectName
        self.__applyGravityForce = applyGravityForce
        self.__bodyPoints = list()
        self.__catenarySystem = None
        self.__structuralMass = None
        self.__linearDamping = None
        self.__quadraticDamping = None
        self.__linearDampingMatrices = list()
        self.__quadraticDampingMatrices = list()
        self.__hydrostaticStiffnessData = None
        self.__nonLinearHydrostaticStiffness = None
        self.__nonlinearBuoyancyCorrection = None
        self.__firstOrderMotionTransferFunction = None
        self.__firstOrderWaveForceTransferFunction = None
        self.__waveDriftForce = None
        self.__waveDriftDamping = None
        self.__simplifiedWaveDriftDamping = None
        self.__quadraticWindCoefficients = None
        self.__linearCurrentCoefficients = None
        self.__quadraticCurrentCoefficients = None
        self.__diffractedWaveField = None
        self.__smallBodyHydrodynamicalData = None
        self.__radiationData = None
        self.__specifiedForces = list()
        self.__specifiedMoments = list()
        self.__thrusters = list()
        self.__controlSystem = None
        self.__slenderElements = list()
        self.__externalDLLForces = list()
        self.__externalHLAForces = list()
        self.__externalForcesFromFile = list()
        self.__fixedBodyElements = list()
        self.__timeDependentPointMasses = list()
        self.__timeDependentVolumeMasses = list()
        self.__slenderSystemConnection = None
        self.__gdfGeometry = None
        self.__fixedForceElongations = list()
        self.__accCOG = Point3()
        self.__liftAndDragForces = list()
        self.__articulatedStructure = ArticulatedStructureData()
        self.__externalControlSystem = None
        self.__dockingConePositionings = list()
        self.__pointBerthingFenders = list()
        self.__rollerBerthingFenders = list()
        self.__bumperDatas = list()
        self.__horizontalAxisWindTurbine = None
        self.__verticalAxisWindTurbine = None
        self.__genericExternalControlSystems = list()
        self.__ballastSystem = None
        self.__hydrodynamicSeparationMethod = hydrodynamicSeparationMethod
        self.__hydrodynamicFilterCutOffPeriod = hydrodynamicFilterCutOffPeriod
        self.__bodyShapeData = None
        self.__qtf = None
