...
class CouplingElementResult(ForceResult):
    ...
    def __init__(self , name:str="", description:str="", _id:str="", fx:float=0.0, fy:float=0.0, fz:float=0.0, mx:float=0.0, my:float=0.0, mz:float=0.0, mass:float=0.0, coupling:str="", branch:str="", **kwargs):
