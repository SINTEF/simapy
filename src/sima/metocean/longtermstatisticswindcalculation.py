...
class LongTermStatisticsWindCalculation(MOAO):
    ...
    def __init__(self , name:str="", description:str="", _id:str="", returnPeriod:float=0.0, method:LevelStatisticsMethod=LevelStatisticsMethod.FROM_DISTRIBUTION, omniMethod:LevelStatisticsMethod=LevelStatisticsMethod.FROM_DISTRIBUTION, directionRelativeToWave:float=0.0, **kwargs):
        ...
        self.__omniMethod = omniMethod
        self.__directionRelativeToWave = directionRelativeToWave
