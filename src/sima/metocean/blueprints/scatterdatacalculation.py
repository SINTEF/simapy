...
class ScatterDataCalculationBlueprint(NamedObjectBlueprint,ConditionSelectableBlueprint):
    ...
    def __init__(self, name="ScatterDataCalculation", package_path="sima/metocean", description=""):
        ...
        self.attributes.append(BlueprintAttribute("currentLevels","sima/metocean/CalculationLevel","",True,Dimension("size","")))
        ...
        self.attributes.append(BlueprintAttribute("scatterData","sima/metocean/ScatterData","",False))
        self.attributes.append(BlueprintAttribute("directions","sima/metocean/CalculationDirection","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("windLevels","sima/metocean/CalculationLevel","",True,Dimension("size","")))