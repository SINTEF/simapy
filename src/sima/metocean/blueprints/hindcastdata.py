...
class HindcastDataBlueprint(NamedObjectBlueprint):
    ...
    def __init__(self, name="HindcastData", package_path="sima/metocean", description=""):
        ...
        self.add_attribute(Attribute("dataFile","string","",default=None))
        self.add_attribute(Attribute("path","string","",default=None))
        self.add_attribute(Attribute("firstDate","string","",default=None))
        self.add_attribute(Attribute("lastDate","string","",default=None))
