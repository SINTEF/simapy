...
class LongTermStatisticsCurrentCalculation(MOAO):
    ...
    def __init__(self , name:str="", description:str="", _id:str="", returnPeriod:float=0.0, method:LevelStatisticsMethod=LevelStatisticsMethod.FROM_DISTRIBUTION, omniMethod:LevelStatisticsMethod=LevelStatisticsMethod.FROM_DISTRIBUTION, directionRelativeToWind:float=0.0, **kwargs):
