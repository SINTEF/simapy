...
class TaskFolderBlueprint(MOAOBlueprint):
    ...
    def __init__(self, name="TaskFolder", package_path="sima/sima", description=""):
        ...
        self.attributes.append(BlueprintAttribute("childFolders","sima/sima/TaskFolder","",True,Dimension("size","")))
        self.attributes.append(BlueprintAttribute("childTasks","sima/sima/Task","",True,Dimension("size","")))
