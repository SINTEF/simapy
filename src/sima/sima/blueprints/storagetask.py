...
class StorageTaskBlueprint(TaskBlueprint):
    ...
    def __init__(self, name="StorageTask", package_path="sima/sima", description=""):
        ...
        self.add_attribute(Attribute("root","string","Defines the root of the storage task. If not set, the root will be the normal workspace task location",default=None))
