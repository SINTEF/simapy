...
class GitTaskFolderBlueprint(TaskFolderBlueprint):
    ...
    def __init__(self, name="GitTaskFolder", package_path="sima/sima", description=""):
        ...
        self.add_attribute(Attribute("remoteURI","string","",default=None))
        self.add_attribute(Attribute("branch","string","",default=None))
        self.add_attribute(Attribute("lastCommitMessage","string","",default=None))
        self.add_attribute(Attribute("repositoryFolder","string","",default=None))