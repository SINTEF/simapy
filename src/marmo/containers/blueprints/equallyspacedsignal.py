...
class EquallySpacedSignalBlueprint(SignalBlueprint):
    ...
    def __init__(self, name="EquallySpacedSignal", package_path="marmo/containers", description="Data model for an equally spaced signal."):
        ...
        self.add_attribute(Attribute("unit","string","",default=None))
        self.add_attribute(Attribute("xunit","string","",default=None))
        self.add_attribute(Attribute("xname","string","",default=None))
        self.add_attribute(Attribute("xlabel","string","",default=None))
        self.add_attribute(Attribute("xdescription","string","",default=None))
        self.add_attribute(Attribute("label","string","",default=None))
        self.add_attribute(Attribute("legend","string","",default=None))