# 
# Generated with PiersonMoskowitzBlueprint
...
class PiersonMoskowitzBlueprint(WaveBlueprint):
    """"""

    def __init__(self, name="PiersonMoskowitz", package_path="sima/environment", description=""):
