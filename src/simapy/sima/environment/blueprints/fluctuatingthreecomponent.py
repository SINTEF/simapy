...
class FluctuatingThreeComponentBlueprint(WindBlueprint):
    ...
    def __init__(self, name="FluctuatingThreeComponent", package_path="sima/environment", description=""):
        ...
        self.add_attribute(Attribute("lowerLeftX","number","X-coordinate of the front lower left data point, in wind aligned coordinates",default=0.0))
        self.add_attribute(Attribute("lowerLeftY","number","Y-coordinate of the front lower left data point, in wind aligned coordinates",default=0.0))
        self.add_attribute(Attribute("lowerLeftZ","number","Z-coordinate of the front lower left data point, in wind aligned coordinates",default=0.0))
