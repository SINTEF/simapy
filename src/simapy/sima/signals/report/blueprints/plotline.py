...
class PlotLineBlueprint(EntityBlueprint):
    ...
    def __init__(self, name="PlotLine", package_path="sima/signals/report", description=""):
        ...
        self.add_attribute(EnumAttribute("linestyle","sima/signals/report/LineStyle",""))
        self.add_attribute(EnumAttribute("pointstyle","sima/signals/report/PointStyle",""))
