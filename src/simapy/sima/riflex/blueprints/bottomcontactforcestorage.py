# 
# Generated with BottomContactForceStorageBlueprint
...
class BottomContactForceStorageBlueprint(ElementReferenceBlueprint):
    """"""

    def __init__(self, name="BottomContactForceStorage", package_path="sima/riflex", description=""):
