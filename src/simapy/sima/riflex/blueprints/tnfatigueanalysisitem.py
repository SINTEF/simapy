# 
# Generated with TnFatigueAnalysisItemBlueprint
...
class TnFatigueAnalysisItemBlueprint(ElementReferenceBlueprint):
    """"""

    def __init__(self, name="TnFatigueAnalysisItem", package_path="sima/riflex", description=""):
        ...
        self.add_attribute(Attribute("referenceBreakingStrength","number","",default=0.0))
        self.add_attribute(Attribute("m","number","Slope M in formula NR^M=K",default=0.0))
        self.add_attribute(Attribute("k","number","Constant K in formula NR^M=K",default=0.0))