# 
# Generated with ElementTransformationBlueprint
...
class ElementTransformationBlueprint(ElementReferenceBlueprint):
    """"""

    def __init__(self, name="ElementTransformation", package_path="sima/riflex", description=""):
