...
class CoupledAxialTorsionStrainModelBlueprint(CrossSectionBlueprint,CRSAxialFrictionModelBlueprint):
    ...
    def __init__(self, name="CoupledAxialTorsionStrainModel", package_path="sima/riflex", description=""):
        ...
        self.add_attribute(EnumAttribute("hydrodynamicInputCode","sima/riflex/DimensionalInput","Hydrodynamic input code"))
        ...
        self.add_attribute(EnumAttribute("hydrodynamicRadiationInputCode","sima/riflex/DimensionalInput","Code for input of simplified radiation force coefficients"))
        ...
        self.add_attribute(EnumAttribute("aerodynamicInput","sima/riflex/DimensionalInput","Aerodynamic input code"))
        self.add_attribute(Attribute("aerodynamicDiameter","number","Aerodynamic diameter",default=0.0))
        self.add_attribute(EnumAttribute("aerodynamicLoadFormulation","sima/riflex/AerodynamicLoadFormulation","Aerodynamic input code"))
        self.add_attribute(BlueprintAttribute("vivCoefficients","sima/riflex/TimeDomainVIVLoadCoefficients","",True))
        self.add_attribute(BlueprintAttribute("aerodynamicVivCoefficients","sima/riflex/TimeDomainVIVLoadCoefficients","",True))
