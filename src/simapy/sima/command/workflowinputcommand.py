...
# 
# Generated with WorkflowInputCommand
from typing import Dict,Sequence,List
from dmt.blueprint import Blueprint
from .blueprints.workflowinputcommand import WorkflowInputCommandBlueprint
from typing import Dict
from ..sima import Property
from ..sima import ScriptableValue
from .command import Command

class WorkflowInputCommand(Command):
    """
    Keyword arguments
    -----------------
    description : str
    ...
    def blueprint(self) -> Blueprint:
        ...
        return WorkflowInputCommandBlueprint()
