...
# 
# Generated with YawPerformanceRelation
from typing import Dict,Sequence,List
from dmt.blueprint import Blueprint
from .blueprints.yawperformancerelation import YawPerformanceRelationBlueprint
from typing import Dict
from ..sima import MOAO
from ..sima import ScriptableValue
from .performancerelationitem import PerformanceRelationItem

class YawPerformanceRelation(MOAO):
    """
    Keyword arguments
    -----------------
    description : str
    ...
    def blueprint(self) -> Blueprint:
        ...
        return YawPerformanceRelationBlueprint()
