...
# 
# Generated with PerformanceRelationItem
from typing import Dict,Sequence,List
from dmt.blueprint import Blueprint
from .blueprints.performancerelationitem import PerformanceRelationItemBlueprint
from typing import Dict
from ..sima import MOAO
from ..sima import ScriptableValue

class PerformanceRelationItem(MOAO):
    """
    Keyword arguments
    -----------------
    description : str
    ...
    def blueprint(self) -> Blueprint:
        ...
        return PerformanceRelationItemBlueprint()
