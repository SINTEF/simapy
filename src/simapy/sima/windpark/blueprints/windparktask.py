...
from ...condition.blueprints.conditiontask import ConditionTaskBlueprint
...
class WindParkTaskBlueprint(ConditionTaskBlueprint):
    ...
    def __init__(self, name="WindParkTask", package_path="sima/windpark", description=""):
        ...
        self.add_attribute(BlueprintAttribute("diwaGenerator","sima/windpark/Generator","",True,Dimension("*")))