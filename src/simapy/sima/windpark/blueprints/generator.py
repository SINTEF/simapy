...
from ...sima.blueprints.conditionselectable import ConditionSelectableBlueprint
...
class GeneratorBlueprint(NamedBlueprint,ConditionSelectableBlueprint):
    ...
    def __init__(self, name="Generator", package_path="sima/windpark", description=""):
        ...
        self.add_attribute(Attribute("useYawMisalignment","boolean","",default=False))
        self.add_attribute(Attribute("interpolateYawMisalignment","boolean","Option for interpolation on specified yaw misalignment performance relations",default=False))
        self.add_attribute(EnumAttribute("wakeFlowModel","sima/windpark/WakeFlowModel",""))
