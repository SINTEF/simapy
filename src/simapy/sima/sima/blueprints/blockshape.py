# 
# Generated with BlockShapeBlueprint
...
class BlockShapeBlueprint(ShapeBlueprint):
    """"""

    def __init__(self, name="BlockShape", package_path="sima/sima", description=""):
        ...
        self.add_attribute(Attribute("sizeZ","number","",default=0.0))