...
class DoubleVariableBlueprint(VariableBlueprint):
    ...
    def __init__(self, name="DoubleVariable", package_path="sima/sima", description=""):
        ...
        self.add_attribute(Attribute("value","number","The current value for the variable",default=0.0))
        self.add_attribute(Attribute("unit","string","unit of variable",default='-'))