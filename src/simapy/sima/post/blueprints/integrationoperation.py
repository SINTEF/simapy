# 
# Generated with IntegrationOperationBlueprint
...
class IntegrationOperationBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="IntegrationOperation", package_path="sima/post", description=""):
