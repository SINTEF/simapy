# 
# Generated with SignalGeneratorBlueprint
...
class SignalGeneratorBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="SignalGenerator", package_path="sima/post", description=""):
        ...
        self.add_attribute(BlueprintAttribute("root","sima/post/SignalGeneratorContainer","",True))