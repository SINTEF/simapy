# 
# Generated with PassThroughFilterBlueprint
...
class PassThroughFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="PassThroughFilter", package_path="sima/post", description=""):
