# 
# Generated with SquareRootFilterBlueprint
...
class SquareRootFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="SquareRootFilter", package_path="sima/post", description=""):
