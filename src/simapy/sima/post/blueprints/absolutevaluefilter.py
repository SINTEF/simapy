# 
# Generated with AbsoluteValueFilterBlueprint
...
class AbsoluteValueFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="AbsoluteValueFilter", package_path="sima/post", description=""):
