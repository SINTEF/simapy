# 
# Generated with SubtractFilterBlueprint
...
class SubtractFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="SubtractFilter", package_path="sima/post", description=""):
