# 
# Generated with PostWorkflowInputBlueprint
...
class PostWorkflowInputBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="PostWorkflowInput", package_path="sima/post", description=""):
