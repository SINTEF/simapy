# 
# Generated with DirectInputSourceBlueprint
...
class DirectInputSourceBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="DirectInputSource", package_path="sima/post", description=""):
