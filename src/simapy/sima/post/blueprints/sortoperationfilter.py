...
class SortOperationFilterBlueprint(OperationNodeBlueprint):
    ...
    def __init__(self, name="SortOperationFilter", package_path="sima/post", description=""):
        ...
        self.add_attribute(EnumAttribute("sortBy","sima/post/SortBy",""))
        self.add_attribute(EnumAttribute("sortDirection","sima/post/SortDirection",""))
        self.add_attribute(Attribute("retainX","boolean","Retain x-axis when sorting by y",default=True))