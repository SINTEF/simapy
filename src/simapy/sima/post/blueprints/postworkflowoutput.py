# 
# Generated with PostWorkflowOutputBlueprint
...
class PostWorkflowOutputBlueprint(OperationNodeBlueprint,OutputNodeBlueprint):
    """"""

    def __init__(self, name="PostWorkflowOutput", package_path="sima/post", description=""):
