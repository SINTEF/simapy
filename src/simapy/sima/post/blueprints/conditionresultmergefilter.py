# 
# Generated with ConditionResultMergeFilterBlueprint
...
class ConditionResultMergeFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="ConditionResultMergeFilter", package_path="sima/post", description=""):
