# 
# Generated with DistanceLineToLineFilterBlueprint
...
class DistanceLineToLineFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="DistanceLineToLineFilter", package_path="sima/post", description=""):
        ...
        self.add_attribute(Attribute("outputVector","boolean","Output the distance vector",default=False))