# 
# Generated with ConditionInputSourceBlueprint
...
class ConditionInputSourceBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="ConditionInputSource", package_path="sima/post", description=""):
