# 
# Generated with SampleCountOperationBlueprint
...
class SampleCountOperationBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="SampleCountOperation", package_path="sima/post", description=""):
