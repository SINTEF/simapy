...
class PolynomialFitFilterBlueprint(OperationNodeBlueprint):
    ...
    def __init__(self, name="PolynomialFitFilter", package_path="sima/post", description=""):
        ...
        self.add_attribute(Attribute("polynomalPower","integer","Polynomal power.",default=2))
        self.add_attribute(Attribute("subtract","boolean","Subtract result from original signal",default=False))