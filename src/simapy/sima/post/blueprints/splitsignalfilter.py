# 
# Generated with SplitSignalFilterBlueprint
...
class SplitSignalFilterBlueprint(OperationNodeBlueprint):
    """"""

    def __init__(self, name="SplitSignalFilter", package_path="sima/post", description=""):
