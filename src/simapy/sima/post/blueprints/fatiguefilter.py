...
class FatigueFilterBlueprint(OperationNodeBlueprint):
    ...
    def __init__(self, name="FatigueFilter", package_path="sima/post", description=""):
        ...
        self.add_attribute(BlueprintAttribute("snCurve","sima/post/SNCurve","",False))
        self.add_attribute(Attribute("outputCycleCount","boolean","",default=False))
        self.add_attribute(BlueprintAttribute("cycleCountSlot","sima/post/OutputSlot","",True))