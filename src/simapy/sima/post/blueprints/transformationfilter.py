...
class TransformationFilterBlueprint(OperationNodeBlueprint):
    ...
    def __init__(self, name="TransformationFilter", package_path="sima/post", description=""):
        ...
        self.add_attribute(Attribute("xp","number","",default=0.0))
        self.add_attribute(Attribute("yp","number","",default=0.0))
        self.add_attribute(Attribute("zp","number","",default=0.0))