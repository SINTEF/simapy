# 
# Generated with WorkflowOutputBlueprint
from dmt.blueprint import Blueprint
from dmt.dimension import Dimension
from dmt.attribute import Attribute
from dmt.enum_attribute import EnumAttribute
from dmt.blueprint_attribute import BlueprintAttribute
from ...post.blueprints.outputnode import OutputNodeBlueprint

class WorkflowOutputBlueprint(OutputNodeBlueprint):
    """"""

    def __init__(self, name="WorkflowOutput", package_path="sima/workflow", description=""):
