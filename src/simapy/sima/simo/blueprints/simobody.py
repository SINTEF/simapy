...
class SIMOBodyBlueprint(BodyBlueprint):
    ...
    def __init__(self, name="SIMOBody", package_path="sima/simo", description=""):
        ...
        self.add_attribute(BlueprintAttribute("differenceFrequencyQtf","sima/hydro/DifferenceFrequencyQTF","",True))
        self.add_attribute(BlueprintAttribute("sumFrequencyQtf","sima/hydro/SumFrequencyQTF","",True))