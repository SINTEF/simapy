...
from ...hydro.blueprints.quadraticdampingmatrix import QuadraticDampingMatrixBlueprint
from ...sima.blueprints.named import NamedBlueprint

class SIMOQuadraticDampingMatrixBlueprint(QuadraticDampingMatrixBlueprint,NamedBlueprint):
    """"""
