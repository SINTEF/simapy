...
class ProplibPropellerAndRudderThrusterBlueprint(IThrusterBlueprint):
    ...
    def __init__(self, name="ProplibPropellerAndRudderThruster", package_path="sima/simo", description=""):
        ...
        self.add_attribute(Attribute("headboxHeight","number","Headbox height",default=0.0))
        self.add_attribute(Attribute("headboxRootChord","number","Headbox root chord",default=0.0))
        self.add_attribute(Attribute("headboxTipChord","number","Headbox tip chord",default=0.0))
        self.add_attribute(Attribute("headboxArea","number","Headbox area",default=0.0))
        self.add_attribute(Attribute("rudderHeight","number","Rudder height",default=0.0))
        self.add_attribute(Attribute("rudderRootChord","number","Rudder root chord",default=0.0))
        self.add_attribute(Attribute("rudderTipChord","number","Rudder tip chord",default=0.0))
        self.add_attribute(Attribute("rudderHornArea","number","Rudder horn area",default=0.0))
        self.add_attribute(Attribute("rudderTotalArea","number","Rudder total area (including horn)",default=0.0))
        self.add_attribute(Attribute("rudderPropellerHorizontalDistance","number","Horizontal distance from propeller plane to rudder stock",default=0.0))
        self.add_attribute(Attribute("rudderPropellerVerticalDistance","number","Vertical distance from propeller plane to rudder top",default=0.0))
        self.add_attribute(Attribute("rudderHeadboxGap","number","Initial gap between rudder and headbox",default=0.0))
