...
from ..hydro import GDFGeometry
from ..hydro import HydrostaticStiffnessData
from ..hydro import LinearCurrentCoefficient
from ..hydro import LinearDampingMatrix
from ..hydro import QuadraticCurrentCoefficient
...
from .externalpythonforce import ExternalPythonForce
...
class SIMOBody(Body):
    ...
    externalPythonForces : List[ExternalPythonForce]
    ...
    def __init__(self , description="", length=10.0, width=5.0, height=5.0, _type=BodyType.SIX_DOF_TIME_DOMAIN, positionsImportType=PositionsImportType.FIXED_POSITION, applyGravityForce=False, hydrodynamicSeparationMethod=HydrodynamicSeparationMethod.BW2_FILTERING, hydrodynamicFilterCutOffPeriod=0.0, **kwargs):
        ...
        self.externalPythonForces = list()
    ...
    @property
    def externalPythonForces(self) -> List[ExternalPythonForce]:
        """"""
        return self.__externalPythonForces

    @externalPythonForces.setter
    def externalPythonForces(self, value: List[ExternalPythonForce]):
        """Set externalPythonForces"""
        if not isinstance(value, Sequence):
            raise ValueError("Expected sequense, but was " , type(value))
        self.__externalPythonForces = value
