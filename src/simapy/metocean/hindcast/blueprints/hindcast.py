...
class HindcastBlueprint(NamedEntityBlueprint):
    ...
    def __init__(self, name="Hindcast", package_path="metocean/hindcast", description="Description for hindcast metocean data."):
        ...
        self.add_attribute(BlueprintAttribute("wave","/hindcast/StochasticWave","wave models.",True,Dimension("*")))
        self.add_attribute(BlueprintAttribute("wind","/hindcast/StochasticWind","wind models.",True,Dimension("*")))
        self.add_attribute(BlueprintAttribute("current","/hindcast/StochasticCurrent","current models.",True,Dimension("*")))