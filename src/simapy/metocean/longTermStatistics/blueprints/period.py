...
class PeriodBlueprint(NamedEntityBlueprint):
    ...
    def __init__(self, name="Period", package_path="metocean/longTermStatistics", description="Description for stochastic process with sampling at certain period."):
        ...
        self.add_attribute(BlueprintAttribute("wave","/longTermStatistics/wave/Stat","models for statistical representation of wave, e.g. omni, or 12sec.",True,Dimension("*")))
        self.add_attribute(BlueprintAttribute("wind","/longTermStatistics/level/Stat","models for statistical representation of wind, e.g. omni, or 12sec.",True,Dimension("*")))
        self.add_attribute(BlueprintAttribute("current","/longTermStatistics/level/Stat","models for statistical representation of current, e.g. omni, or 12sec.",True,Dimension("*")))