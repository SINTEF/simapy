...
class SectorBlueprint(NamedEntityBlueprint):
    ...
    def __init__(self, name="Sector", package_path="metocean/longTermStatistics/wave", description="Description for wave at a sector."):
        ...
        self.add_attribute(BlueprintAttribute("weibullDistribution","/longTermStatistics/wave/Weibull","weibull parameters for Hs.",True))
        self.add_attribute(BlueprintAttribute("extremeValues","/longTermStatistics/wave/JointExtremeValues","joined extreme values for Hs and Tp.",True))
        self.add_attribute(BlueprintAttribute("spectralPeak","/longTermStatistics/wave/SpectralPeak","Spectral peak period as a function of Hs.",True))
        self.add_attribute(BlueprintAttribute("contours","/longTermStatistics/wave/Contour","Hs-Tp contours",True,Dimension("*")))