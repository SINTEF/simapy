...
class SectorBlueprint(NamedEntityBlueprint):
    ...
    def __init__(self, name="Sector", package_path="metocean/scatter", description="Description for stochastic process at a sector."):
        ...
        self.add_attribute(BlueprintAttribute("wave","/scatter/Wave","the scatter data for wave.",True))
        self.add_attribute(BlueprintAttribute("wind","/scatter/WindCurrent","the scatter data for wind at different levels.",True,Dimension("*")))
        self.add_attribute(BlueprintAttribute("current","/scatter/WindCurrent","the scatter data for current at different levels.",True,Dimension("*")))