...
class MetoceanBlueprint(NamedEntityBlueprint):
    ...
    def __init__(self, name="Metocean", package_path="metocean", description="Description for scatter data based on Hs-Tp."):
        ...
        self.add_attribute(BlueprintAttribute("hindcasts","/hindcast/Hindcast","hindcast data.",True,Dimension("*")))
        self.add_attribute(BlueprintAttribute("scatters","/scatter/Scatter","scatter data.",True,Dimension("*")))
        self.add_attribute(BlueprintAttribute("longterms","/longTermStatistics/LongTermStats","scatter data.",True,Dimension("*")))